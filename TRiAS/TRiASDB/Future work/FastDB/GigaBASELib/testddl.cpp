...
//-------------------------------------------------------------------*--------*
// Test of GigaBASE data definition and manipulation facilities. 
// First create database by running this application, then 
// fill database by "subsql testddl.sql" and then run this application once
