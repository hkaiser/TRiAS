// ----------------------------------------------------------------------
//
// NT_calibrate.cc - produce calibration for non-standard world views
// 
// Specific for VC++ under NT.
//
//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-\\
//                                                                     \\
// NOTICE:                                                             \\
...
//   09-Feb-1999  MF   NT-specific file completed.
//
// ----------------------------------------------------------------------
...
// JFC, the abovegives a compile error about timestamp(ctime) !!!
...
"//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-\\\\\n"
"//\n"
"// Auto-generation date:  " << (timestamp+4) << "\n"
"// File generated on:     Windows NT under VC++\n"
"//\n"
"// ----------------------------------------------------------------------\n"
  ;
