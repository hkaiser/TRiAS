...
// *** IProgressIndicator methods ***
	...
	STDMETHOD(Restart)(THIS_ LONG uiMinPos, LONG ulMaxPos, DWORD dwFlags);
	...
	STDMETHOD_(int, SetPosition)(THIS_ LONG uiNewPos);
	STDMETHOD_(BOOL, WasCanceled)(THIS);

// *** IProgressIndicator2 methods ***
// #if _MSC_VER >= 1100
	STDMETHOD(InitNew)(THIS_ LONG hWndParent, LONG dwReserved, LONG *pHWND);
// #else	
//	STDMETHOD(InitNew)(THIS_ HWND hWndParent, DWORD dwReserved, HWND *pHWND);
// #endif // _MSC_VER >= 1100
	STDMETHOD(Restart)(THIS_ LONG uiMinPos, LONG ulMaxPos, PIFLAGS rgFlags);
	...
	STDMETHOD(SetPosition)(THIS_ LONG ulNewPos, INT *piPercent);
    STDMETHOD(IncrementPosition)(THIS_ INT *piPercent);
    STDMETHOD(IsCanceled)(THIS);
    STDMETHOD(get_Canceled)(VARIANT_BOOL *pfIsCanceled);

	STDMETHOD(get_Flags)(THIS_ PIFLAGS *prgFlags);
	STDMETHOD(put_Flags)(THIS_ PIFLAGS rgFlags);
	STDMETHOD(RetrieveRange)(THIS_ LONG *pulMinPos, LONG *pulMaxPos);
