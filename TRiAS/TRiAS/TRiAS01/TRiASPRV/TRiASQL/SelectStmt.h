...
class ATL_NO_VTABLE cSelectStmt : 
	...
	public IDispatchImpl<ISelectStmt, &IID_ISelectStmt, &LIBID_TRiASOleDB, 
...
public:
	...
	STDMETHOD(get_Distinct)(/*[out, retval]*/ VARIANT_BOOL *pVal);

// #HK010714: ADDED
	STDMETHOD(get_TopRowsPercent)(/*[out, retval]*/ VARIANT_BOOL *pVal);
	STDMETHOD(get_TopRows)(/*[out, retval]*/ ULONG *pVal);
};
