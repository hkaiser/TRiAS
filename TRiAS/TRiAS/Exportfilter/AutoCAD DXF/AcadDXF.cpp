...
// Created: 21.11.2000 09:40:48 
//
// @doc
// @module AcadDXF.cpp | DLL entry points, licensing
...
CComModule _Module;
char pDLLName [_MAX_PATH];               // globaler DLL-Name

BEGIN_OBJECT_MAP(ObjectMap)
	OBJECT_ENTRY(CLSID_AcadDXFExport, CAcadDXFExport)
END_OBJECT_MAP()
