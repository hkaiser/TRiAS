/**
 **	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imvfblight.c,v 1.9 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imvfblight.c,v 1.9 1995/06/29 00:28:04 bduggan Exp $ "
...
#endif
{
		...
		(type == IMVFBINDEX8 || type == IMVFBINDEX16) )
	{
		for ( i = 0; i < ncolors; i++ )
		{
			...
			y = (float)(IM_YFRGB( r, g, b ));
			u = (float)(IM_UFRGB( r, g, b ));
			v = (float)(IM_VFRGB( r, g, b ));
