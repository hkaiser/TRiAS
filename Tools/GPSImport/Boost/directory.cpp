...
struct boost::filesystem::dir_it::representation
{
	...
	string const &operator* () { return m_current; }
	...
	void set_mode(umode_t m, bool nv)
	{
...
namespace boost
{
	namespace filesystem
	{
		...
		template <> string get<uname>(dir_it const &it)
			{
		...
		template <> void set<uname>(dir_it const &it, string name)
			{
		...
		template <> string get<gname>(dir_it const &it)
			{
		...
		template <> void set<gname>(dir_it const &it, string name)
			{
