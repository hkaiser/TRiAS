...
//
// @doc
// @module TRiASHPObject.cpp | Implementation of the <c CTRiASHPObject> class
...
STDMETHODIMP CTRiASHPObject::InterfaceSupportsErrorInfo(REFIID riid)
{
...
STDMETHODIMP CTRiASHPObject::get_DefaultType (BSTR *pbstrType)
{
...
STDMETHODIMP CTRiASHPObject::SetupObject(SETUPOBJECTMODE rgMode)
{
	...
	WTRiASPropertyMapHandler MapHandler(m_BaseUnk);
		...
		THROW_FAILED_HRESULT(MapHandler -> AddMapEntry (
			CComBSTR(g_cbObjectCursor), (INT_PTR)&CLSID_TRiASHPCursorProperty, PROPERTYSUPPORT_NOFLAGS, vtMissing));

	} COM_CATCH;
	return S_OK;
}

STDMETHODIMP CTRiASHPObject::OnChanging (CHANGEDOBJECT rgWhat, VARIANT vNewValue, VARIANT_BOOL *pDisAllow)
{
...
STDMETHODIMP CTRiASHPObject::OnChanged (CHANGEDOBJECT rgWhat, VARIANT vOldValue)
{
#if defined(_READWRITE)
	return S_OK;
#else
...
STDMETHODIMP CTRiASHPObject::OnFinalRelease()
{
	COM_TRY {
...
STDMETHODIMP CTRiASHPObject::OnDelete()
{
// diese Funktion wird nur dann gerufen, wenn CTRiASHPObjects::OnDelete() E_NOTIMPL
// geliefert hat.
#if defined(_READWRITE)
...
STDMETHODIMP CTRiASHPObject::SetupFeatures(SETUPFEATURESMODE rgMode)
{
...
/////////////////////////////////////////////////////////////////////////////
// IOleClientSite
STDMETHODIMP CTRiASHPObject::GetMoniker (DWORD dwAssign, DWORD dwWhich, IMoniker **ppIMk)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	switch (dwWhich) {
...
HRESULT CTRiASHPObject::GetContainerMoniker (IMoniker **ppIMk)
{
	COM_TRY {
...
HRESULT CTRiASHPObject::GetThisMoniker (DWORD dwWhich, IMoniker **ppIMk)
{
	if (NULL == ppIMk)
		return E_POINTER;
	*ppIMk = NULL;
