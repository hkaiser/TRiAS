/**
 **	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imvfbto.c,v 1.18 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imvfbto.c,v 1.18 1995/06/29 00:28:04 bduggan Exp $"
...
// ADDED: #HK991110: evtl. invertieren
	if (monoThreshold < 0) {
...
#endif
{
	...
	for( i = 0, bp = Blist; i < maxcolors; i++, bp = bp->b_next )
	{
		...
		fprintf( stderr, "RGB = %3d , %3d , %3d\n",
			bp->b_mean[IMVT_R], bp->b_mean[IMVT_G], bp->b_mean[IMVT_B] );
#endif
