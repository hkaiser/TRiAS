/**
 **	$Header: /sdsc/dev/vis/misc/libsdsc/v3.0/libsdsc/src/RCS/bin.c,v 1.18 1995/06/30 21:52:27 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/misc/libsdsc/v3.0/libsdsc/src/RCS/bin.c,v 1.18 1995/06/30 21:52:27 bduggan Exp $"
...
#endif
{
	...
	case FDIO:	/* File descriptor.				*/
		...
		{
			switch ( (nBytes = _read( fd, pBuffer, n-cnt )) )
			{
			case 0:	/* EOF reached.				*/
				return ( cnt );
			case -1:/* Error.				*/
...
#endif
{
	...
	case FDIO:	/* File descriptor.				*/
		for ( cnt = 0, pBuffer = buffer; cnt != n; )
		{
			switch ( (nBytes = _write( fd, (char *)pBuffer, n-cnt )) )
			{
			case 0:	/* EOF reached.				*/
				return ( cnt );
			case -1:/* Error.				*/
