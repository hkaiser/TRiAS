...
//  IntStringMap is a Map with {\tt long} data as keys and Strings as values.

class YACL_BASE CL_IntStringMap: public CL_Map<long, CL_String> {
...
class YACL_BASE CL_IntIntMap: public CL_Map<long, long> {
...
class YACL_BASE CL_IntPtrMap: public CL_Map<long, CL_ObjectPtr> {
...
class YACL_BASE CL_StringStringMap: public CL_Map<CL_String, CL_String> {
...
class YACL_BASE CL_StringIntMap: public CL_Map<CL_String, long> {
...
class YACL_BASE CL_StringPtrMap: public CL_Map<CL_String, CL_ObjectPtr> {
...
class YACL_BASE CL_PtrIntMap: public CL_Map<CL_ObjectPtr, long> {
