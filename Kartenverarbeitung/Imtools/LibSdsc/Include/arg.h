...
IMTOOLS_API extern int   ArgErrNo;			/* Current error number		*/
IMTOOLS_API extern int   ArgNErr;			/* Number of error messages	*/
IMTOOLS_API extern char *ArgErrList[];		/* List of error messages	*/
...
#ifdef __STDC__
IMTOOLS_API extern void		ArgPError( char * );
IMTOOLS_API extern char *		ArgQError( void );
IMTOOLS_API extern int		ArgHelp( void );
IMTOOLS_API extern int		ArgFullHelp( void );
IMTOOLS_API extern int		ArgFeedback( void );
IMTOOLS_API extern int		ArgRegister( void );
IMTOOLS_API extern int		ArgVersion( void );
IMTOOLS_API extern int		ArgParse( int, char *[ ], ArgCommand *, int, ArgOption *, int, ArgEquiv * );
IMTOOLS_API extern int		ArgQNOpt( void );
IMTOOLS_API extern int		ArgQOccurOpt( char *, int );
IMTOOLS_API extern char *		ArgQOpt( int, int * );
IMTOOLS_API extern int		ArgQNOccur( char * );
IMTOOLS_API extern int		ArgQNValue( char *, int );
IMTOOLS_API extern ArgValue *	ArgQValue( char *, int, int );
#else
