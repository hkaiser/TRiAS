...
GETWERTHANDLER VIOGetWert;			// StandardRoutinen
GETLINKHANDLER VIOGetLink;
GETWERTHANDLER VMOGetWert;			// StandardRoutinen
GETLINKHANDLER VMOGetLink;
...
// Konstruktor/Destruktor
		CKonsistenzTestKontext (GeoDB &, long = 0, int iTyp = OBL_OLD, 
