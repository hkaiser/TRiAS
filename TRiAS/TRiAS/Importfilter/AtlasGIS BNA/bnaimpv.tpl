// VersionsInfoStruktur fuer BNAIMP.EXT ---------------------------------------
// File: BNAIMP.RCV
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"Erweiterung zum Import aus dem PolyGIS-BNA-Austauschformat.\0"
#define VER_INTERNALNAME_STR		"BNAIMP\0"
#define VER_ORIGINALFILENAME_STR	"BNAIMP.EXT\0"
