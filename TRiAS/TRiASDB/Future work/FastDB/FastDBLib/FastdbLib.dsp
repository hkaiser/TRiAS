...
# ADD CPP /nologo /MD /W3 /GX /Zi /O2 /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "USE_QUEUE_MANAGER" /D "THROW_EXCEPTION_ON_ERROR" /D "USE_STD_STRING" /YX /Fd"Release/Fastdb.pdb" /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "USE_QUEUE_MANAGER" /D "THROW_EXCEPTION_ON_ERROR" /D "USE_STD_STRING" /FR /YX /Fd"Debug/Fastdbd.pdb" /FD /GZ /c
