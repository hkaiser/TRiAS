...
// #HK000313
	LRESULT OnNotImplementedMessage (HPROJECT, LPARAM);	// Nicht (hier) implementierte Message
...
// diese Funktionsdeklarationen sind lediglich für eine Datei notwendig
	...
	LRESULT OnEnumObjectFeaturesClassEx (HPROJECT, LPARAM); // DEX_ENUMMERKMALECLASSEX
	...
	LRESULT OnSetActiveORWnd (HPROJECT, LPARAM);	// DEX_SETACTIVEORWINDOW
	LRESULT OnGetStartView (HPROJECT, LPARAM);		// DEX_QUERYSTARTVIEW
	LRESULT OnSetStartView (HPROJECT, LPARAM);		// DEX_MODIFYSTARTVIEW
	LRESULT OnGetDescription (HPROJECT, LPARAM);	// DEX_QUERYPROJECTDESC
	LRESULT OnGetDataSourceName (HPROJECT, LPARAM);	// DEX_QUERYDATASOURCENAME
	LRESULT OnGetMRUItem (HPROJECT, LPARAM);		// DEX_QUERYMRUITEM
	LRESULT OnDelMRUItem (HPROJECT, LPARAM);		// DEX_DELETEMRUITEM
	LRESULT OnAddMRUItem (HPROJECT, LPARAM);		// DEX_ADDMRUITEM
	...
	LRESULT OnGetActiveProjectPtr (HPROJECT, LPARAM);	// DEX_QUERYACTIVEPROJECTPTR
...
// #HK981222
	LRESULT OnGetNamedViewProperty (HPROJECT, LPARAM);	// DEX_QUERYNAMEDVIEWPROPERTY
	LRESULT OnSetNamedViewProperty (HPROJECT, LPARAM);	// DEX_MODNAMEDVIEWPROPERTY

// #HK990118
	LRESULT OnGetObjectProject (HPROJECT, LPARAM);	// DEX_QUERYOBJECTPROJECT
	LRESULT OnGetObjectsProject (HPROJECT, LPARAM);	// DEX_QUERYOBJECTSPROJECT
	LRESULT OnSetShownCoords (HPROJECT, LPARAM);	// DEX_MODIFYSHOWNCOORDS

// #HK990128
	LRESULT OnGetDataSourceCount (HPROJECT, LPARAM);	// DEX_QUERYDATASOURCECOUNT

// #HK990223
	LRESULT OnEnumClassProjects (HPROJECT, LPARAM);	// DEX_ENUMPROJECTSFORCLASS

// #HK990415
	LRESULT OnMapMCodeToHandle (HPROJECT, LPARAM);	// DEX_GETHANDLEFROMMCODE

// #HK990529
	LRESULT OnGetFeatureProject (HPROJECT, LPARAM);	// DEX_QUERYFEATUREPROJECT

// #HK990601
	LRESULT OnIsTRiASDataSource (HPROJECT, LPARAM);	// DEX_QUERYTRIASDATASOURCE
	LRESULT OnIsOpened (HPROJECT, LPARAM);			// DEX_QUERYDATASOURCEOPEN
	LRESULT OnDexQueryROModeIdent (HPROJECT, LPARAM);	// DEX_GETROMODEIDENT
	LRESULT OnDexQueryROModeMCode (HPROJECT, LPARAM);	// DEX_GETROMODEMCODE

// #HK990604
	LRESULT OnGetTableName (HPROJECT, LPARAM);		// DEX_QUERYTABLENAME

// #HK990610
	LRESULT OnGetObjGuidMCode (HPROJECT, LPARAM);	// DEX_QUERYOBJGUIDMCODE

// #HK990613
	LRESULT OnGetDataSourceFromShortName (HPROJECT, LPARAM);	// DEX_PROJECTHANDLEFROMSHORTNAME
	LRESULT OnEnumDatasourceHandles (HPROJECT, LPARAM);	// DEX_ENUMALLPROJECTHANDLES
	LRESULT OnMapHandleToMCode (HPROJECT, LPARAM);		// DEX_GETMCODEFROMHANDLE
	
// #HK990616
	LRESULT OnGetContextDataSource (HPROJECT, LPARAM);	// DEX_QUERYCONTEXTPROJECT

// #HK990618
	LRESULT OnMapOrCreateMCodeToHandle (HPROJECT, LPARAM);	// DEX_MAPORCREATEHANDLEFROMMCODE

// #HK000124
	LRESULT OnDexModifyROModeIdent (HPROJECT, LPARAM);	// DEX_MODIFYROMODEIDENT
	LRESULT OnDexModifyROModeMCode (HPROJECT, LPARAM);	// DEX_MODIFYROMODEMCODE

// #HK000126
	LRESULT OnDexQuerySchemaUpdatable (HPROJECT, LPARAM);	// DEX_QUERYSCHEMAUPDATABLE

// #HK000221
	LRESULT OnIsGDODataSource (HPROJECT, LPARAM);		// DEX_QUERYGDODATASOURCE

// #HK000225
	LRESULT OnDeleteObjectRect (HPROJECT, LPARAM);		// DEX_DELOBJECTUNDORECT

// #HK000313
	LRESULT OnIsObjectInClass (HPROJECT, LPARAM);		// DEX_OBJECTISINCLASS
	LRESULT OnEnumObjectClasses (HPROJECT, LPARAM);		// DEX_ENUMCLASSESFROMOBJECT
	LRESULT OnUnloadObject (HPROJECT, LPARAM);			// DEX_UNLOADOBJECTFROMMEMORY
	LRESULT OnGetNativeObject (HPROJECT, LPARAM);		// DEX_QUERYNATIVEOBJECT

// #HK000408
	LRESULT OnHandleImportMode (HPROJECT, LPARAM);		// DEX_CHANGEIMPORTMODE

// #HK000412
	LRESULT OnHandleNotificationMode (HPROJECT, LPARAM);	// DEX_CHANGENOTIFICATIONMODE
	LRESULT OnHandleMRUMenu (HPROJECT, LPARAM);			// DEX_MRUMENUMODE

// #HK000526
	LRESULT OnGetRelatedDataSourceName (HPROJECT, LPARAM);	// DEX_RELATEDDATASOURCENAME

// #HK000705
	LRESULT OnGetFeatureIdent (HPROJECT, LPARAM);		// DEX_QUERYFEATUREIDENT

// #HK000713
	LRESULT OnShowPrintLayoutDlg (HPROJECT, LPARAM);	// DEX_SHOWPRINTLAYOUTDIALOG
	LRESULT OnPrintPreview (HPROJECT, LPARAM);			// DEX_PREVIEWPRINT
	LRESULT OnEndPrintPreview (HPROJECT, LPARAM);		// DEX_ENDPREVIEWPRINT

// #HK000807
	LRESULT OnShowStartupDialog (HPROJECT, LPARAM);		// DEX_SHOWSTARTUPDIALOG

// #HK001022
	LRESULT OnCloneObject (HPROJECT, LPARAM);			// DEX_CLONEOBJECT
...
// #HK001220
	LRESULT OnGetTextFeature (HPROJECT, LPARAM);		// DEX_QUERYTEXTFEATURE

// #HK010306
	LRESULT OnGetObjDescString (HPROJECT, LPARAM);		// DEX_QUERYOBJECTDESCSTRING
	LRESULT OnZoomInToObject (HPROJECT, LPARAM);		// DEX_ZOOMIN2OBJECT

// #HK010309
	LRESULT OnRefreshEntries (HPROJECT, LPARAM);		// DEX_REFRESHENTRY
...
// #HK010922
	LRESULT OnQueryMayOpenLegend (HPROJECT, LPARAM);	// WM_QUERYMAYOPENLEGEND
	LRESULT OnQueryMayOpenOverview (HPROJECT, LPARAM);	// WM_QUERYMAYOPENOVERVIEW

// #HK020306
	LRESULT OnQueryObjContainerEx (HPROJECT, LPARAM);	// DEX_QUERYOBJCONTAINEREX

// #HK020413
	LRESULT OnShowObjPropEx (HPROJECT, LPARAM);			// DEX_SHOWOBJPROPEX
	LRESULT OnGetObjPropEx (HPROJECT, LPARAM);			// DEX_QUERYOBJPROPEX

// #HK020415
	LRESULT OnSetLimitSearches (HPROJECT, LPARAM);		// DEX_SETLIMITSEARCHES
	LRESULT OnGetLimitSearches (HPROJECT, LPARAM);		// DEX_QUERYLIMITSEARCHES
	LRESULT OnQueryWindowAsDbCoords (HPROJECT, LPARAM);	// DEX_QUERYWINDOWASDBCONTAINER
	LRESULT OnSetIgnoreSearchOptions (HPROJECT, LPARAM);	// DEX_SETIGNORESEARCHOPTIONS
	LRESULT OnGetIgnoreSearchOptions (HPROJECT, LPARAM);	// DEX_QUERYIGNORESEARCHOPTIONS
...
// #HK020926
	LRESULT OnQueryDropSourceORWnd (HPROJECT, LPARAM);	// WM_QUERYDROPSOURCEORWND

// #HK021209
	LRESULT OnQueryObjectPtr (HPROJECT, LPARAM);		// DEX_QUERYOBJECTPTR
	LRESULT OnQueryObjectsPtr (HPROJECT, LPARAM);		// DEX_QUERYOBJECTSPTR
	LRESULT OnQueryFeaturePtr (HPROJECT, LPARAM);		// DEX_QUERYFEATUREPTR

// #HK021217
	LRESULT OnCreateConnectionFilter (HPROJECT, LPARAM);	// DEX_CREATECONNECTIONFILTER
	LRESULT OnDeleteConnectionFilter (HPROJECT, LPARAM);	// DEX_DELETECONNECTIONFILTER
	LRESULT OnEnumConnectionFilters (HPROJECT, LPARAM);		// DEX_ENUMCONNECTIONFILTERS
	LRESULT OnAttachConnectionFilter (HPROJECT, LPARAM);	// DEX_ATTACHCONNECTIONFILTER
	LRESULT OnDetachConnectionFilter (HPROJECT, LPARAM);	// DEX_DETACHCONNECTIONFILTER
	LRESULT OnGetAttachedConnectionFilter (HPROJECT, LPARAM);	// DEX_QUERYATTACHEDCONNECTIONFILTER

// #HK021219
	LRESULT OnShowCreateConnectionFilterDlg (HPROJECT, LPARAM);	// DEX_CREATECONNECTIONFILTER_DLG

	LRESULT OnQueryActSelectionEx (HPROJECT, LPARAM);	// DEX_QUERYACTIVESELECTIONEX
	LRESULT OnQueryWindowAsCoords (HPROJECT, LPARAM);	// DEX_QUERYWINDOWASCONTAINER
...
// #HK030117
	LRESULT OnGetConnectionFilter (HPROJECT, LPARAM);	// DEX_QUERYCONNECTIONFILTER

// #HK041112
	LRESULT OnExecuteSequence(HPROJECT, LPARAM);	    // DEX_EXECUTECOMMANDSEQUENCE
