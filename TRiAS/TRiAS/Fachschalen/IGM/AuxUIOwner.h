...
public:
	...
	HRESULT SetExtension (class CKompiasExtension *pExt);
...
private:
	UIOwnerData m_Data;
	class CKompiasExtension *m_pXtsn;
...
// Regeln der Button in Toolbar
    bool m_fOpenEreignis;
	bool m_fOpenWasser;
...
///////////////////////////////////////////////////////////////////////////////
// COMMANDPROC 
	HRESULT OnCmdEreignis (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdWasser (ITRiASBar *pIBar, UINT uiID, int nCode);
};
