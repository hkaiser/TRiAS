...
//
// @doc
// @module PropertyActionSplit.h | Declaration of the <c CPropertyActionSplit> class

#if !defined(_PROPERTYACTIONSPLIT_H__FB8EBB7A_E065_47D2_9A1E_625E05C3680C__INCLUDED_)
#define _PROPERTYACTIONSPLIT_H__FB8EBB7A_E065_47D2_9A1E_625E05C3680C__INCLUDED_
...
class ATL_NO_VTABLE CPropertyActionSplit : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CPropertyActionSplit, &CLSID_PropertyActionSplit>,
	public IObjectWithSiteImpl<CPropertyActionSplit>,
...
public:
	...
	CPropertyActionSplit() : 
		CPropertyActionImpl (PA_TYPEFLAGS, IDS_DESCRIPTION_PROPERTYACTIONSPLIT)
	{
	}

	DECLARE_REGISTRY_RESOURCEID(IDR_PROPERTYACTIONSPLIT)
	BEGIN_CATEGORY_MAP(CPropertyActionSplit)
		IMPLEMENTED_CATEGORY(CATID_TRiASGeoComponentContainer)
		IMPLEMENTED_CATEGORY(CATID_TRiASGeoComponent)
	END_CATEGORY_MAP()

	DECLARE_PROTECT_FINAL_CONSTRUCT()
	BEGIN_COM_MAP(CPropertyActionSplit)
...
///////////////////////////////////////////////////////////////////////////////
// Versionen für Speichern eines PropertyActionSplit
const DWORD PROPERTYACTIONSPLIT_SIGNATURE = 0x53434150;	// "PACS"
const DWORD PROPERTYACTIONSPLIT_VERSION_100 = 0x0100;
const DWORD PROPERTYACTIONSPLIT_MINOR_MASK = 0xff;
const DWORD PROPERTYACTIONSPLIT_LASTVERSION = PROPERTYACTIONSPLIT_VERSION_100;

#endif // !defined(_PROPERTYACTIONSPLIT_H__FB8EBB7A_E065_47D2_9A1E_625E05C3680C__INCLUDED_)
