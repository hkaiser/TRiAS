...
'    vbdzBlk.szExtProgTitle = "EDBS_ZIP Status"
    ...
    If hResult <> ZE_OK Then
        ...
        MsgBox szTemp, MB_OK + MB_ICONINFORMATION, "EDBS_ZIP-Warnung"
    End If
...
Function UnzipFileFromFile(szExtProgTitle As String, szZIP As String, szDestination As String, szFile As String) As Integer
  ...
  vbduzBlk.szZIPFile = szZIP    'The ZIP file name
  vbduzBlk.szFileSpec = szFile  'The file to be added
  vbduzBlk.szDestination = szDestination
  vbduzBlk.szExtProgTitle = szExtProgTitle

  'Actually perform the ZIP_ADD
  UnzipFileFromFile = dunzipVB(ucs, vbduzBlk, zi, statusBlk)
...
Sub initZIPCmdStruct(zcs As ZIPCMDSTRUCT)
  ...
  zcs.noDirectoryNamesFlag = 1            'True
