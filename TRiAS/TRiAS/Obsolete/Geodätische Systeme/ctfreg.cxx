...
bool UpdateRegistry (bool fRegister)	// RegDB aktualisieren (initialisieren/löschen)
{
	...
	// RegDB initialisieren
		return RegisterHandler (CLSID_CTFBesselGeodProp, 
					TEXT("TRiASEx.CTFBesselGeodExt.1"), IDS_LONGCLASSINFO, 
				CLSID_DirisProject, TEXT("TRiAS.Document.2"));
	} else {
	// RegDB säubern
		return UnRegisterHandler (
				CLSID_CTFBesselGeodProp, TEXT("TRiASEx.CTFBesselGeodExt.1"), 
				CLSID_DirisProject, TEXT("TRiAS.Document.2"));
	}
#elif defined(ELLIPSE_KRASSOVSKI)
	if (fRegister) {
	// RegDB initialisieren
		return RegisterHandler (CLSID_CTFKrassGeodProp, 
					TEXT("TRiASEx.CTFKrassovskyGeodExt.1"), IDS_LONGCLASSINFOKR, 
				CLSID_DirisProject, TEXT("TRiAS.Document.2"));
	} else {
	// RegDB säubern
		return UnRegisterHandler (
				CLSID_CTFKrassGeodProp, TEXT("TRiASEx.CTFKrassovskyGeodExt.1"), 
				CLSID_DirisProject, TEXT("TRiAS.Document.2"));
	}
#else
