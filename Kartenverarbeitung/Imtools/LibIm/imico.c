/**
 **     $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imico.c,v 1.12 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER  "	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imico.c,v 1.12 1995/06/29 00:28:04 bduggan Exp $"
...
{
	{ IM_UINT16_TYPE, 2, 1 },		/* ico_idReserved		*/
	{ IM_UINT16_TYPE, 2, 1 },		/* ico_idType			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* ico_idCount			*/
	{ 0, 0, 0 }
};
...
{
	{ IM_UCHAR_TYPE, 1, 1 },		/* ico_Width			*/
	{ IM_UCHAR_TYPE, 1, 1 },		/* ico_Height			*/
	{ IM_UCHAR_TYPE, 1, 1 },		/* ico_ColorCount		*/
	{ IM_UCHAR_TYPE, 1, 1 },		/* ico_Reserved			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* ico_Planes			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* ico_BitCount			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_ByteInRes		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_ImageOffset		*/
	{ 0, 0, 0 }
};
...
{
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_bisize			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_biwidth			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_biheight			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* ico_biplanes			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* ico_bibitcount		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_bicompress		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_bisizeimage		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_bixpm			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_biypm			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_biclrused		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* ico_biclrim			*/
	{ 0, 0, 0 }
};
...
#endif
{
	...
	if ( y < icony )
	{
		...
		for ( i = icony - y; i > 0; i-- )
		{
			if( ImBinWrite( ioType,fd,fp,wbuf,IM_UCHAR_TYPE,
				1,scanlinesize )== -1 )
			{
				ImReturnBinError( );
			}
