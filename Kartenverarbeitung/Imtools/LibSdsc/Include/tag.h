...
IMTOOLS_API extern int   TagErrNo;			/* Current error number		*/
IMTOOLS_API extern int   TagNErr;			/* Number of error messages	*/
IMTOOLS_API extern char *TagErrList[];		/* List of error messages	*/
...
#ifdef __STDC__
IMTOOLS_API extern void		TagPError( char * );
IMTOOLS_API extern char *		TagQError( void );

IMTOOLS_API extern TagTable *	TagTableAlloc( void );
IMTOOLS_API extern void		TagTableFree( TagTable * );

IMTOOLS_API extern TagEntry *	TagEntryAlloc( char *, int, void * );
IMTOOLS_API extern void		TagEntryFree( TagEntry * );
IMTOOLS_API extern TagEntry *	TagEntryDup( TagEntry * );

IMTOOLS_API extern int		TagTableAppend( TagTable *, TagEntry * );
IMTOOLS_API extern int		TagTableInsert( TagTable *, int, TagEntry * );
IMTOOLS_API extern int		TagTableDelete( TagTable *, int );
IMTOOLS_API extern int		TagTableReplace( TagTable *, int, TagEntry * );
IMTOOLS_API extern int		TagTableCopy( TagTable *, TagTable *, int, int );

IMTOOLS_API extern int		TagTableQNEntry( TagTable *, char * );
IMTOOLS_API extern TagEntry *	TagTableQLinear( TagTable *, int );
IMTOOLS_API extern TagEntry *	TagTableQDirect( TagTable *, char *, int );

IMTOOLS_API extern char *		TagEntryQTag( TagEntry * );
IMTOOLS_API extern int		TagEntryQNthOccur( TagEntry * );
IMTOOLS_API extern int		TagEntryQNthEntry( TagEntry * );
IMTOOLS_API extern int		TagEntryQValueType( TagEntry * );
IMTOOLS_API extern int		TagEntryQValue( TagEntry *, void * );
#else
