...
char cbFile[_MAX_FNAME];

	_splitpath (HeaderFileName, cbDrive, cbPath, NULL, NULL);
	_splitpath (MessageFileName, NULL, NULL, cbFile, NULL);
	_makepath (HeaderFileName, cbDrive, cbPath, cbFile, HeaderFileExt);

//	strcat( HeaderFileName, FileName );
//	strcat( HeaderFileName, ".");
//	strcat( HeaderFileName, HeaderFileExt );

	_makepath (RcInclFileName, cbDrive, cbPath, cbFile, ".rc");
