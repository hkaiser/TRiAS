...
start:
		call	sub_1			; (0056)
		db	'TRiASЎ - VisModule fќr spezielle Flфchenfќllmuster', 0DH, 0AH
		db	'V@A.@B (Build @C) - Copyright Љ 1991 - 1997, '
		db	'uve GmbH Fernerkundungszentrum Potsdam, #@D', 0Dh, 0Ah
		db	0Dh, 0Ah
		db	'Dieses Programm erfordert WindowsNT, Windows 95 oder '
