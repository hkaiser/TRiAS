...
static const char* rcsid = "@(#)$RCSfile: dh_usr.c,v $ $Revision: 1.1.2.1 $ (DOWNHILL) $Date: 1997/04/17 06:17:19 $";
#endif
...
char* Downhill_User_Dir = _DOWNHILL_USER_DIR;
char* Downhill_User_Shell = _DOWNHILL_USER_SHELL;
