...
public:
	...
	HRESULT SetExtension (class CBerlinExt *pExt);
...
///////////////////////////////////////////////////////////////////////////////
// COMMANDPROC 
	HRESULT OnCmdALB (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdBlink (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdGiTest (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdFTeil (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdUnBau (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdInsel (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdNummer (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdIdent (ITRiASBar *pIBar, UINT uiID, int nCode);
	HRESULT OnCmdObjNummer (ITRiASBar *pIBar, UINT uiID, int nCode);
};
