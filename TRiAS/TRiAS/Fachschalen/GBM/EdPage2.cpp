// EdPage2.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CEditPage2 property page

IMPLEMENT_DYNCREATE(CEditPage2, CPropertyPage)

CEditPage2::CEditPage2() : CPropertyPage(CEditPage2::IDD)
{
	//{{AFX_DATA_INIT(CEditPage2)
...
void CEditPage2::SpecialDDX_Text( CDataExchange *pDX, UINT id, double &r )
{
...
void CEditPage2::SpecialDDX_Check( CDataExchange *pDX, UINT id, BOOL &r )
{
	if ( !pDX -> m_bSaveAndValidate )
	{
		CWnd    *pWnd = GetDlgItem( id );
...
void CEditPage2::HideControl( CDataExchange *pDX, UINT id )
{
	if ( !pDX -> m_bSaveAndValidate )
	{
		CWnd    *pWnd = GetDlgItem( id );
...
/////////////////////////////////////////////////////////////////////////////
// CEditPage2 message handlers

void CEditPage2::SetGeaendert( BOOL flag )
{
	((CErfassPrivDlg*)GetParent()) -> SetDGeaendert( flag );
}

void CEditPage2::InitData()
{
	short		i, n;
	CWnd		*pWnd;
	CPG2DSatz	*pSatz;
	...
	m_iGebZahl = m_parrPG2D -> GetSize();
	n = m_iGebZahl - m_iOffset;
	if ( n > 20 ) n = 20;
	for ( i = 0; i < n; i++ )
	{
		pSatz = (CPG2DSatz*)m_parrPG2D -> GetAt( i + m_iOffset );
...
void CEditPage2::OnDelete() 
{
	...
	text = ((CPG2DSatz*)m_parrPG2D -> GetAt( 0 )) -> m_NFP2_FLN;
	for ( i = 1; i < m_parrPG2D -> GetSize(); i++ )
	{
		text += '|';
		text += ((CPG2DSatz*)m_parrPG2D -> GetAt( i )) -> m_NFP2_FLN;
	}
	dlg.m_strListe = text;
	dlg.m_strTitel.LoadString( IDS_DELE_DT );
	if ( dlg.m_strTitel.IsEmpty())
		dlg.m_strTitel = "Dachteilflächen löschen";
	...
	if ( dlg.DoModal() == IDOK )
	{
		...
		if ( !text.IsEmpty())
		{
			...
			for ( i = 0; i < m_parrPG2D -> GetSize(); i++ )
			{
				text.Empty();
				text.printf( "D%d", i + 1 );
				((CPG2DSatz*)m_parrPG2D -> GetAt( i )) -> m_NFP2_FLN = text;
			}
...
void CEditPage2::OnAnschl1()	{	SetGeaendert();	}
void CEditPage2::OnAnschl10()	{	SetGeaendert();	}
void CEditPage2::OnAnschl11()	{	SetGeaendert();	}
void CEditPage2::OnAnschl12()	{	SetGeaendert();	}
void CEditPage2::OnAnschl13()	{	SetGeaendert();	}
void CEditPage2::OnAnschl14()	{	SetGeaendert();	}
void CEditPage2::OnAnschl15()	{	SetGeaendert();	}
void CEditPage2::OnAnschl16()	{	SetGeaendert();	}
void CEditPage2::OnAnschl17()	{	SetGeaendert();	}
void CEditPage2::OnAnschl18()	{	SetGeaendert();	}
void CEditPage2::OnAnschl19()	{	SetGeaendert();	}
void CEditPage2::OnAnschl2()	{	SetGeaendert();	}
void CEditPage2::OnAnschl20()	{	SetGeaendert();	}
void CEditPage2::OnAnschl3()	{	SetGeaendert();	}
void CEditPage2::OnAnschl4()	{	SetGeaendert();	}
void CEditPage2::OnAnschl5()	{	SetGeaendert();	}
void CEditPage2::OnAnschl6()	{	SetGeaendert();	}
void CEditPage2::OnAnschl7()	{	SetGeaendert();	}
void CEditPage2::OnAnschl8()	{	SetGeaendert();	}
void CEditPage2::OnAnschl9()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit10()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit11()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit12()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit13()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit14()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit15()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit16()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit17()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit18()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit19()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit20()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit21()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit22()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit23()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit24()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit25()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit26()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit27()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit28()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit29()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit30()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit31()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit32()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit33()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit34()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit35()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit36()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit37()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit38()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit39()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit40()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit41()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit42()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit43()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit44()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit45()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit46()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit47()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit48()	{	SetGeaendert();	}
void CEditPage2::OnChangeEdit49()	{	SetGeaendert();	}
