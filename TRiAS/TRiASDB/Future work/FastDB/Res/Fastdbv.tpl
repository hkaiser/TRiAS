// VersionsInfoStruktur für Fastdb.dll
// File: Fastdb.rcv
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"TRiASDB Data Server Module Fastdb.\0"
#define VER_INTERNALNAME_STR		"Fastdb\0"
#define VER_ORIGINALFILENAME_STR	"Fastdb.dll\0"
