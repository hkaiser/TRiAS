 ...
 */
#define IM_POINTER_TYPE	0
#define IM_CHAR_TYPE	1
#define IM_UCHAR_TYPE	2
#define IM_SHORT_TYPE	3
#define IM_LONG_TYPE	4
#define IM_INT_TYPE	5
#define IM_INT8_TYPE	6
#define IM_INT16_TYPE	7
#define IM_INT32_TYPE	8
#define IM_USHORT_TYPE	9
#define IM_ULONG_TYPE	10
#define IM_UINT_TYPE	11
#define IM_UINT8_TYPE	12
#define IM_UINT16_TYPE	13
#define IM_UINT32_TYPE	14
#define IM_BOOLEAN_TYPE	15
#define IM_FLOAT_TYPE	16
#define IM_DOUBLE_TYPE	17
#define IM_INT64_TYPE	18
#define IM_UINT64_TYPE	19
 ...
 */
IMTOOLS_API extern int BinErrNo;			/* Current error number		*/
IMTOOLS_API extern int BinNErr;			/* Number of error messages	*/
IMTOOLS_API extern char *BinErrList[];		/* List of error messages	*/
...
#ifdef __STDC__
IMTOOLS_API extern BinMachineInfo *	BinQMachine( void );
IMTOOLS_API extern void		BinPError( char * );
IMTOOLS_API extern char *		BinQError( void );
IMTOOLS_API extern void		BinErrorHandler( int (*)(int, int, int, void*, int, int ) );
IMTOOLS_API extern int		BinByteOrder( int );
IMTOOLS_API extern int		BinQByteOrder( void );
IMTOOLS_API extern int		BinFloatFormat( int );
IMTOOLS_API extern int		BinQFloatFormat( void );
IMTOOLS_API extern int		BinRead( int, void *, int, int, int );
IMTOOLS_API extern int		BinFRead( FILE *, void *, int, int, int );
IMTOOLS_API extern int		BinSRead( unsigned char *, void *, int, int, int );
IMTOOLS_API extern int		BinWrite( int, void *, int, int, int );
IMTOOLS_API extern int		BinFWrite( FILE *, void *, int, int, int );
IMTOOLS_API extern int		BinSWrite( unsigned char *, void *, int, int, int );
IMTOOLS_API extern int		BinReadStruct( int, void *, BinField * );
IMTOOLS_API extern int		BinFReadStruct( FILE *, void *, BinField * );
IMTOOLS_API extern int		BinSReadStruct( unsigned char *, void *, BinField * );
IMTOOLS_API extern int		BinWriteStruct( int, void *, BinField * );
IMTOOLS_API extern int		BinFWriteStruct( FILE *, void *, BinField * );
IMTOOLS_API extern int		BinSWriteStruct( unsigned char *, void *, BinField * );
#else
