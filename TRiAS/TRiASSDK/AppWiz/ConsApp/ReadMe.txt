========================================================================
                    CUSTOM APPWIZARD: ConsApp
========================================================================


AppWizard has created a ConsApp DLL for you.  This DLL is the starting point
...
you build ConsApp.awx, it will automatically be copied to your Template
...
ConsAppAw.h, ConsAppAw.cpp - the CCustomAppWiz class
    These files contain your CCustomAppWiz-derived class,
    CConsAppAppWiz.  This class contains virtual member functions which
...
Template\
    ...
    import that file as a "TEMPLATE" custom resource into ConsApp.rc.  Be
...
Template\NewProj.inf
    ...
    generated from the project "D:\TRiASDev\ListDirs\ListDirs.dsp".
...
off of the project "D:\TRiASDev\ListDirs\ListDirs.dsp".
...
StdAfx.h, StdAfx.cpp
    ...
    named ConsApp.pch and a precompiled types file named StdAfx.obj.
