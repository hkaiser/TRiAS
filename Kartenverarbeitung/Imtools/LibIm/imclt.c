/**
 **	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imclt.c,v 1.8 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imclt.c,v 1.8 1995/06/29 00:28:04 bduggan Exp $"
...
#endif
{
	...
	{
		delta  = (float)(endGray - startGray);
		delta /= (float)(endIndex - startIndex);

		gray = (float)startGray;
