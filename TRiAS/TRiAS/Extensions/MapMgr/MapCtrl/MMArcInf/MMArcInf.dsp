# Microsoft Developer Studio Project File - Name="MMArcInf" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Dynamic-Link Library" 0x0102

CFG=MMARCINF - WIN32 DEBUG
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "MMArcInf.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "MMArcInf.mak" CFG="MMARCINF - WIN32 DEBUG"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "MMArcInf - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "MMArcInf - Win32 Release" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 

# Begin Project
# PROP AllowPerConfigDependencies 0
# PROP Scc_ProjName ""$/Xtension/MapMgr/MMArcInf", LTDAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe

!IF  "$(CFG)" == "MMArcInf - Win32 Debug"
...
# ADD LINK32 /nologo /subsystem:windows /dll /debug /machine:I386 /out:"_Debug/MMArcInfD.dll" /pdbtype:sept
# Begin Custom Build - Copying Target to Destination ...
OutDir=.\_Debug
TargetPath=.\_Debug\MMArcInfD.dll
TargetName=MMArcInfD
InputPath=.\_Debug\MMArcInfD.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "MMArcInf - Win32 Release"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
# PROP BASE Output_Dir "MMArcInf"
# PROP BASE Intermediate_Dir "MMArcInf"
# PROP BASE Target_Dir ""
# PROP Use_MFC 2
...
OutDir=.\_Release
TargetPath=.\_Release\MMArcInf.dll
TargetName=MMArcInf
InputPath=.\_Release\MMArcInf.dll
SOURCE="$(InputPath)"
...
# Name "MMArcInf - Win32 Debug"
# Name "MMArcInf - Win32 Release"
# Begin Group "Source Files"

# PROP Default_Filter "cpp;c;cxx;rc;def;r;odl;idl;hpj;bat"
# Begin Source File

SOURCE=.\MapArcInfo.cpp
# End Source File
# Begin Source File
...
InputPath=.\MMArcInf.idl

BuildCmds= \
	midl /Oicf /h "MMArcInf.h" /iid "MMArcInf_i.c" "MMArcInf.idl"

".\MMArcInf.tlb" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\MMArcInf.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\MMArcInf_i.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
