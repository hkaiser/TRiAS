/**********************************************************************
 *
 *  geoextra.c  -- Public routines for GEOTIFF GeoKey access.
 *
...

{
    ...
    else if( MapSys == MapSys_State_Plane )
    {
	int		i;
...
/*                          GTIFPCSToMapSys()                           */
/*                                                                      */
/*      Trnanslate a PCS code into a Map system code (eg                */
/*      MapSys_UTM_North, MapSys_UTM_South, MapSys_State_Plane), Datum	*/
/*	(GCS_*) and a zone.                                             */
/************************************************************************/
