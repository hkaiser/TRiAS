...
//
// @doc 
// @module TRiASHPDBEngine.cpp |  Databaseengine für TRiASDB Data Server TRiASHP
...
CTRiASHPDBEngine *g_pDBEngine = NULL;
...
STDMETHODIMP CTRiASHPDBEngine::InterfaceSupportsErrorInfo(REFIID riid)
{
...
HRESULT CTRiASHPDBEngine::FinalConstruct (void)
{
	return S_OK;
}

void CTRiASHPDBEngine::FinalRelease()
{
...
STDMETHODIMP CTRiASHPDBEngine::put_Password (BSTR bstrPwd)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CTRiASHPDBEngine::put_UserName (BSTR bstrUser)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
STDMETHODIMP CTRiASHPDBEngine::Start (STARTMODE rgMode)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
...
{
	g_cbDatabase,		// ProgID des Database-Objektes (s. TRiASHPDatabase.h)
};
...
STDMETHODIMP CTRiASHPDBEngine::Stop()
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
