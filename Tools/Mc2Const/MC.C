...
McPrintUsage( void )
{
    ...
    fprintf( stderr, "                     Default is .\\\n" );
    fprintf( stderr, "       -e fileext  - gives the extension of the generated C include file\n" );
    fprintf( stderr, "                     Default is '.h'\n" );
    ...
    )
{
    ...
    strcpy( HeaderFileExt, "d" );		// Dockumentation extension
