/**
 **     $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imlzw.c,v 1.8 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER  "    $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imlzw.c,v 1.8 1995/06/29 00:28:04 bduggan Exp $"
...
#endif
{
	if ( ImBinWrite( ioType, fd, fp, 
		imLzwSp->lzwRawdata, IM_UCHAR_TYPE, 1, imLzwSp->lzwRawcc ) == -1 )
                ImReturnBinError( );
