...
#define DEXN_ClosingRechObjWindow(hWnd)	\
	(bool)DexNotificationProc((WPARAM)DEX_N_CLOSINGOBJWND,(LPARAM)(void *)(hWnd))
#define DEXN_RechObjWindowToClose(hWnd)	\
	(bool)DexNotificationProc((WPARAM)DEX_N_OBJWNDTOCLOSE,(LPARAM)(void *)(hWnd))
...
#define DEXN_ReReadObjectProperties(l)	\
	DexNotificationProc((WPARAM)DEX_N_REREADOBJPROPS,(l))
...
#define DEXN_MenuesHandled()	\
	DexNotificationProc((WPARAM)DEX_N_HANDLEMENU,(LPARAM)0L)
...
#define DEXN_MenuChanged(l)			\
	DexNotificationProc((WPARAM)DEX_N_MENUCHANGED,(LPARAM)&(l))
#define DEXN_ChangingMenu(l)		\
	(bool)DexNotificationProc((WPARAM)DEX_N_CHANGINGMENU,(LPARAM)&(l))

#define DEXN_FeatureModified(l)		\
	(bool)DexNotificationProc((WPARAM)DEX_MODIFYMERKMAL,(LPARAM)l)
#define DEXN_FeatureModifiedEx(l)		\
	(bool)DexNotificationProc((WPARAM)DEX_N_MODIFYMERKMAL,(LPARAM)&(l))
#define DEXN_FeatureSetModified(l)		\
	(bool)DexNotificationProc((WPARAM)DEX_N_MODIFYMERKMALSET,(LPARAM)l)
...
#define TRIASUI_LEGACYLOOK		0x00
#define TRIASUI_COOLLOOK		0x01
#define TRIASUI_OVERALLCOOLLOOK	0x02
...
#define DEXN_ObjectCreated(l)	\
	DexNotificationProc((WPARAM)DEX_N_OBJECTCREATED_EDIT,(LPARAM)(l))

///////////////////////////////////////////////////////////////////////////////
// OLE-bezogene Notifikationen (#AD...)
#define DEXN_OleUpdateClient()	\
	DexNotificationProc((WPARAM)DEX_OLEUPDATECLIENT, (LPARAM)0)
#define DEXN_OleReturnToClient()	\
	DexNotificationProc ((WPARAM)DEX_OLERETURN, (LPARAM)0)

///////////////////////////////////////////////////////////////////////////////
// Caption modifizieren/anpassen
#define DEXN_ReReadCaption(l)	\
	DexNotificationProc((WPARAM)DEX_CAPTIONREREAD,(LPARAM)(l))

///////////////////////////////////////////////////////////////////////////////
// Projektfenster wird angezeigt/ausgeblendet
#define DEXN_ProjectWindowShownOrHidden(l)	\
	DexNotificationProc((WPARAM)DEX_N_HIDEORSHOWPROJECTWINDOW,(LPARAM)(l))

///////////////////////////////////////////////////////////////////////////////
// Darstellungsparameter übernehmen
#define DEXN_VisInfoCopied(l)	\
	DexNotificationProc((WPARAM)DEX_N_COPYVISINFO,(LPARAM)&(l))

///////////////////////////////////////////////////////////////////////////////
// Objekt erzeugen
#define DEXN_AddingObject(hPr)	\
	(BOOL)DexNotificationProc((WPARAM)DEX_N_ADDINGOBJECT,(LPARAM)(hPr))
#define DEXN_ObjectToAdd(l)	\
	DexNotificationProc((WPARAM)DEX_N_OBJECTTOADD,(LPARAM)(l))
#define DEXN_ObjectAdded(l)	\
	DexNotificationProc((WPARAM)DEX_N_OBJECTADDED,(LPARAM)(l))
