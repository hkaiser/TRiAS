// VersionsInfoStruktur fuer COLORS.DLL ---------------------------------------
// File: COLORSV.RC2
...
#define VER_FILEDESCRIPTION_STR		\
	"TRiAS® - Territoriales Raumbezogenes Informations- und Abfragesystem, "	\
	"Farbregelungs- und Farbkonvertierungsobjekte.\0"
#define VER_INTERNALNAME_STR		"COLORS\0"
#define VER_ORIGINALFILENAME_STR	"COLORS.EBN\0"
