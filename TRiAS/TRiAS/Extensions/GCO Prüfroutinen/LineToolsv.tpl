// VersionsInfoStruktur für LineTools.ext 
// File: LineTools.rcv
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"TRiAS®-Zusatzmodul LineTools.\0"
#define VER_INTERNALNAME_STR		"LineTools\0"
#define VER_ORIGINALFILENAME_STR	"LineTools.ext\0"
