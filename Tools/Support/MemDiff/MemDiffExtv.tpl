// VersionsInfoStruktur fuer MemDiffExt.ext 
// File: MemDiffExt.rcv
...
// ----------------------------------------------------------------------------
// VersionsInfo, wird bei jedem build aktualisiert
...
#define VER_LEGALCOPYRIGHT_STR	"Copyright© @I 1991 - 1999, #@D\0"
#define VER_PRODUCTNAME_STR  	\
	"InterTRiAS® - Territoriales Raumbezogenes Informations- und Abfragesystem\0"
#define VER_LEGALTRADEMARKS_STR	\
	"InterTRiAS® ist ein eingetragenes Warenzeichen der TRiAS GmbH.\0"
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"TRiAS®-Zusatzmodul MemDiffExt.\0"
#define VER_INTERNALNAME_STR		"MemDiffExt\0"
#define VER_ORIGINALFILENAME_STR	"MemDiffExt.ext\0"
