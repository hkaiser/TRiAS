// VersionsInfoStruktur fuer EDBSIMP.EXT ---------------------------------------
// File: FAKEMFC.RCV
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"Import aus dem EDBS-Format (ATKIS).\0"
#define VER_INTERNALNAME_STR		"EDBSIMP\0"
#define VER_ORIGINALFILENAME_STR	"EDBSIMP.EXT\0"
