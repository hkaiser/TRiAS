...
///////////////////////////////////////////////////////////////////////////////
// Lizensierungs-Routinen (werden aus Classfactory der Erweiterung gerufen)
...
VERIFYLICENSE VL;
	...
	VL.lLevelOrOption = CKIOPTION_KOMPAKT;
...
ResString resLicCap (ResID (IDS_KOMPPAGECAPTIONX, &RF), 64);
