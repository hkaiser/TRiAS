...
extern COORDTRANSFORMTYPE g_CTFType;	// GK-Koordinaten anzeigen
extern COORDTRANSFORMMODE g_CTFMode;	// wenn GK, dann Meridian automatiosch auswählen
extern int g_iMeridian;					// Meridian für GK
extern int g_iStrBreite;				// Streifenbreite für GK
extern int g_iPrec;						// Darstellungsgenauigkeit
extern bool g_fInitialized;				// CTF wurde ordnungsgemäß geladen
extern COORDTRANSELLIPSE g_rgChangeEllipse;		// mit EllipsoidÜbergang

extern "C" char g_pDLLName[260];			// Name dieses Modules

#if defined(ELLIPSE_BESSEL)
static const TCHAR szOldName[] = TEXT("BEGEOD");
#elif defined(ELLIPSE_KRASSOVSKI)
static const TCHAR szOldName[] = TEXT("KRGEOD");
#elif defined(ELLIPSE_ETRS89)
static const TCHAR szOldName[] = TEXT("ETRSGEOD");
#else
...
// alles ok, Page(s) anlegen
	...
	ResourceFile RF (g_pDLLName);
		...
		m_pCTFPropPage = new CCTFParams (
					...
					g_CTFType, g_CTFMode, g_iMeridian, g_iStrBreite, g_iPrec, 
					g_rgChangeEllipse);
	} catch (...) {
