...
// Created: 12/30/1998 12:01:59 AM
//
// @doc
// @module EventLogMacros.h | This file provides the macros and definitions 
// used by the extensible counters for reporting events to the event logging 
// facility

#if !defined(_EVENTLOGMACROS_H__467452A9_9CBA_11D2_9F09_006008447800__INCLUDED_)
#define _EVENTLOGMACROS_H__467452A9_9CBA_11D2_9F09_006008447800__INCLUDED_
...
#define REPORT_SUCCESS(i,l) \
	(g_dwMsgLevel >= l ? ReportEvent (g_hEventLog, EVENTLOG_INFORMATION_TYPE, 0, i, (PSID)NULL, 0, 0, NULL, (PVOID)NULL) : FALSE)

#define REPORT_INFORMATION(i,l) \
	(g_dwMsgLevel >= l ? ReportEvent (g_hEventLog, EVENTLOG_INFORMATION_TYPE, 0, i, (PSID)NULL, 0, 0, NULL, (PVOID)NULL) : FALSE)

#define REPORT_WARNING(i,l) \
	(g_dwMsgLevel >= l ? ReportEvent (g_hEventLog, EVENTLOG_WARNING_TYPE, 0, i, (PSID)NULL, 0, 0, NULL, (PVOID)NULL) : FALSE)

#define REPORT_ERROR(i,l) \
	(g_dwMsgLevel >= l ? ReportEvent (g_hEventLog, EVENTLOG_ERROR_TYPE, 0, i, (PSID)NULL, 0, 0, NULL, (PVOID)NULL) : FALSE)

#define REPORT_INFORMATION_DATA(i,l,d,s) \
	(g_dwMsgLevel >= l ? ReportEvent (g_hEventLog, EVENTLOG_INFORMATION_TYPE, 0, i, (PSID)NULL, 0, s, NULL, (PVOID)(d)) : FALSE)

#define REPORT_WARNING_DATA(i,l,d,s) \
	(g_dwMsgLevel >= l ? ReportEvent (g_hEventLog, EVENTLOG_WARNING_TYPE, 0, i, (PSID)NULL, 0, s, NULL, (PVOID)(d)) : FALSE)

#define REPORT_ERROR_DATA(i,l,d,s) \
	(g_dwMsgLevel >= l ? ReportEvent (g_hEventLog, EVENTLOG_ERROR_TYPE, 0, i, (PSID)NULL, 0, s, NULL, (PVOID)(d)) : FALSE)

///////////////////////////////////////////////////////////////////////////////
// External Variables
extern HANDLE g_hEventLog;		// handle to event log
extern DWORD g_dwLogUsers;		// counter of event log using routines
extern DWORD g_dwMsgLevel;		// event logging detail level
...
#endif // !defined(_EVENTLOGMACROS_H__467452A9_9CBA_11D2_9F09_006008447800__INCLUDED_)
