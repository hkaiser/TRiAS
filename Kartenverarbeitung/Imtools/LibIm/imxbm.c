/**
 **	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imxbm.c,v 1.15 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imxbm.c,v 1.15 1995/06/29 00:28:04 bduggan Exp $"
 ...
 **
 **  DESCRIPTION
 **	imxbm.c contains routines to read and _write Sun Icon files for
 ...
 **	imXbmWrite		f  _write a X11 Bitmap file
 **
 **
 **  HISTORY
 **	$Log: imxbm.c,v $
 ...
 **	made read/_write routines static
 ...
 **	Updated copyright notice.  Added code to read/_write hotspots, instead
 ...
 **
 **	name is the name of the glyph.  imxbm.c _write code generates the
...
/*
 *  FUNCTION
 *	imXbmWrite	-  _write a X11 bitmap file
 *
 *  DESCRIPTION
