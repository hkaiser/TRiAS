// ConsAppaw.cpp : implementation file
//
...
void CConsAppAppWiz::ExitCustomAppWiz()
{
...
void CConsAppAppWiz::CustomizeProject(IBuildProject* pProject)
{
...
CString strRoot;
	...
	// C++ Einstellungen korrigieren
		Cfg -> RemoveToolSettings (CComBSTR("cl.exe"), CComBSTR("/D \"_WINDOWS\""), vtMissing);
		Cfg -> AddToolSettings (CComBSTR("cl.exe"), CComBSTR("/D \"_CONSOLE\""), vtMissing);
		
	// Linker Einstellungen korrigieren
		Cfg -> RemoveToolSettings (CComBSTR("link.exe"), CComBSTR("/subsystem:windows"), vtMissing);
		Cfg -> AddToolSettings (CComBSTR("link.exe"), CComBSTR("/subsystem:console"), vtMissing);
	...
	CString strBuild = "nmake -nologo -f version.mak ";
		...
		Cfg -> AddCustomBuildStepToFile (CComBSTR("res/copystrt.tpl"), CComBSTR(strBuild + "res/copystr.rc"), CComBSTR("res/copystr.rc"), CComBSTR("Performing Custom Build Step on $(InputPath)"), vtMissing);
...
// Here we define one instance of the CConsAppAppWiz class.  You can access
//  m_Dictionary and any other public members of this class through the
//  global ConsAppaw.
CConsAppAppWiz ConsAppaw;

///////////////////////////////////////////////////////////////////////////////
// AddGuid
BOOL CConsAppAppWiz::AddGuid (LPCTSTR pcEntry, BOOL fReplaceDash)
{
GUID Guid;
