// CvrtBna.cpp : Implementation of DLL Exports.


// Note: Proxy/Stub Information
//      To build a separate proxy/stub DLL, 
//      run nmake -f CvrtBnaps.mk in the project directory.
...
BEGIN_OBJECT_MAP(ObjectMap)
	OBJECT_ENTRY(CLSID_ConvertBnaCoords, CConvertBnaCoords)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_CvrtBna);
