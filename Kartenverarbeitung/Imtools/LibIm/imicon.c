/**
 **	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imicon.c,v 1.10 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imicon.c,v 1.10 1995/06/29 00:28:04 bduggan Exp $"
 ...
 **
 **  DESCRIPTION
 **	imicon.c contains routines to read and _write Sun Icon files for
 ...
 **	imIconWrite		f  _write a Sun Icon file
 **
 **  HISTORY
 **	$Log: imicon.c,v $
...
#endif
{
	...
	if ( (ioType & IMFILEIOFD) && (fp = _fdopen( fd, "r" )) == NULL )
	{
		ImErrNo = IMESYS;
		return ( -1 );
	}
...
/*
 *  FUNCTION
 *	imIconWrite	-  _write a Sun Icon file
 *
 *  DESCRIPTION
