/**
 **     $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imcur.c,v 1.12 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER  "	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imcur.c,v 1.12 1995/06/29 00:28:04 bduggan Exp $"
...
{
	{ IM_UINT16_TYPE, 2, 1 },		/* cur_idReserved		*/
	{ IM_UINT16_TYPE, 2, 1 },		/* cur_idType			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* cur_idCount			*/
	{ 0, 0, 0 }
};
...
{
	{ IM_UCHAR_TYPE, 1, 1 },		/* cur_Width			*/
	{ IM_UCHAR_TYPE, 1, 1 },		/* cur_Height			*/
	{ IM_UCHAR_TYPE, 1, 1 },		/* cur_ColorCount		*/
	{ IM_UCHAR_TYPE, 1, 1 },		/* cur_Reserved			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* cur_XHotspot			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* cur_YHotspot			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_ByteInRes		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_ImageOffset		*/
	{ 0, 0, 0 }
};
...
{
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_bisize			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_biwidth			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_biheight			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* cur_biplanes			*/
	{ IM_UINT16_TYPE, 2, 1 },		/* cur_bibitcount		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_bicompress		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_bisizeimage		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_bixpm			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_biypm			*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_biclrused		*/
	{ IM_UINT32_TYPE, 4, 1 },		/* cur_biclrim			*/
	{ 0, 0, 0 }
};
