...
//	Methoden der Basisklasse
	STDMETHOD(Restart)(LONG ulMinPos, LONG ulMaxPos, PIFLAGS Flags);
	...
	STDMETHOD(get_Canceled)(VARIANT_BOOL *pfCanceled);
//#if _MSC_VER >= 1100
	STDMETHOD(InitNew)(LONG hWnd, LONG dwReserved, LONG *phWnd);
//#else
...
//#endif // _MSC_VER >= 1100
	...
	STDMETHOD(RetrieveRange)(LONG *pulMinPos, LONG *pulMaxPos);
