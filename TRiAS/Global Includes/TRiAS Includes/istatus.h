...
interface DECLSPEC_UUID("07963818-3123-101C-BB62-00AA0018497C")
IProgressIndicator : public IUnknown
{
// *** IUnknown methods ***
...
// *** IProgressIndicator methods ***
	...
	STDMETHOD(Restart)(THIS_ LONG uiMinPos, LONG ulMaxPos, DWORD dwFlags) PURE;
	...
	STDMETHOD_(int, SetPosition)(THIS_ LONG uiNewPos) PURE;
