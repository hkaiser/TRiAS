...
#ifdef MSWIND
#include <imtoolsapi.h>
#if !defined(VOID) && !defined(_USE_MMFS_FOR_VFB)
#define VOID
#endif // !defined(VOID) && !defined(_USE_MMFS_FOR_VFB)
#define LBF
#define CHAR_SIZE 	8
#define SHORT_SIZE 	16
#define INT_SIZE 	32
#define LONG_SIZE 	32
#define FLOAT_TYPE 	IEEE_FLOAT
#define CPU_NAME	"i686"
#define MACHINE_NAME	"Tecra 780 DVD"
#define VENDOR_NAME	"Toshiba"
#define OS_NAME		"Windows 2000"
#endif

#if !defined(IMTOOLS_API)
#define IMTOOLS_API
#endif // !defined(IMTOOLS_API)
