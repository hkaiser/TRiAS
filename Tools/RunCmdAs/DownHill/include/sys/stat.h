...
/*
 * HISTORY
 * 	Add definitions for mkdir, fstat, and stat
 * 	[1997/06/27  08:47:33  gpilz]
 *
...
/* Prototype stuff ***********************************************************/
int Downhill_Directory_Make(char *, mode_t);
int Downhill_File_Stat(const char *, struct Downhill_File_Stat *);
int Downhill_File_StatFd(int, struct Downhill_File_Stat *);
int lstat(const char *, struct stat *);

#else

/*
 * If we're not using the Downhill functions just define functions to
 * their MSVC++ equivalents.
 */
