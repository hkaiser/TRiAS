...
public:
	...
	void SetFlags(DWORD dwFlags, const CString& sTitle, const CString& sExtFilter, 
...
void DDX_GetFilenameControl(CDataExchange* pDX, int nIDC, 
	CGetFilenameControl& rCGetFilenameControl, DWORD dwFlags, const CString& sTitle, 
	const CString& sExtFilter, const CString& sDefExt, const CString &sDir);
