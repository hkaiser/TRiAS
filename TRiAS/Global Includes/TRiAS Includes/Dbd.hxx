...
class _TRIAS01_ENTRY CDBDictCompoundFile : 
	public CDBDict 
{
protected:
...
public:
		CDBDictCompoundFile (BOOL fCompressed = FALSE) : m_fCompressed(fCompressed) {}
		~CDBDictCompoundFile (void) {}
		
static CDBDictCompoundFile *CreateInstance (LPBYTE pResource, BOOL fCompressed = FALSE);
