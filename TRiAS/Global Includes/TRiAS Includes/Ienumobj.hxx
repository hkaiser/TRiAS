...
interface DECLSPEC_UUID("0796380E-3123-101C-BB62-00AA0018497C")
IEnumLONG : public IUnknown
{
// *** IUnknown methods
...
interface DECLSPEC_UUID("0796385B-3123-101C-BB62-00AA0018497C")
IQueryEnumLONG : public IUnknown
{
// *** IUnknown methods
	STDMETHOD (QueryInterface) (THIS_ REFIID riid, LPVOID *ppvObj) PURE;
	STDMETHOD_ (ULONG, AddRef) (THIS) PURE;
