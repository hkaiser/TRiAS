// VersionsInfoStruktur fuer GEOEDIT.EXT ---------------------------------------
// File: GeoEditV.rc
...
#define VER_LEGALCOPYRIGHT_STR  "Copyright © @I, Wolfgang Moertl 1991 - 2005, #@D\0"
#define VER_PRODUCTNAME_STR     \
        "ITRiAS® - Territoriales Raumbezogenes Informations- und Abfragesystem.\0"
...
#define VER_FILEDESCRIPTION_STR         \
    ...
    "Erweiterung zur Geometrie-Editierung.\0"
#define VER_INTERNALNAME_STR            "GEOEDIT\0"
#define VER_ORIGINALFILENAME_STR        "GEOEDIT.EXT\0"
