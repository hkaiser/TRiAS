    ...
    switch (m) { /* actions associated with grammar rules */
      ...
      case 7:{       
      			...
      			if (y_flag) {
      				...
      				strcpy (IdInBuffer, yypvt[-7].strtok.string);
      			}
      ...
      case 8:{       
      			...
      			if (y_flag) {
      				...
      				strcpy (IdInBuffer, yypvt[-9].strtok.string);
      			}
      ...
      case 9:{       
      			...
      			if (y_flag) {
      				...
      				strcpy (IdInBuffer, yypvt[-5].strtok.string);
      			}
      ...
      case 10:{       
      			...
      			if (y_flag) {
      				...
      				strcpy (IdInBuffer, yypvt[-3].strtok.string);
      			}
