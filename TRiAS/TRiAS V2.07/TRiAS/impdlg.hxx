...
// Konstruktor (Initialisierung des Dialogfensters)
		CImportDlg (pWindow, ExtensionList &rEL, CoordTrans *pCTF);
		~CImportDlg (void);

static CImportDlg *CreateInstance (pWindow, ExtensionList &, CoordTrans *);
...
friend LRESULT SelectCoordSysParams (Window *pW, UINT uiID, CoordTrans *pCTF = NULL);
