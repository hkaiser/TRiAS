...
#define ERRCODE_FROM_HRESULT(x)	(ErrCode)(x ? (((x) & 0x00008000) ? ((x) | 0xFFFF0000) : ((x) & 0x0000FFFF)) : 0)

// FehlerCodes
enum ErrCode {
// alles ignorieren
	WC_IGNOREALL = 12345,		// sämtliche Warnungen ignorieren
	EC_IGNOREALL = -12345,		// sämtliche Fehler ignorieren

	WC_DATASOURCE_ISRO = 2000,		// Datenquelle ist schreibgeschützt
	WC_METADATA_ISRO = 2001,		// Beschreibungsdaten sind schreibgeschützt
	WC_CLASS_ISRO = 2002,			// Objektklasse (Tabelle) ist schreibgeschützt
	WC_FEATURE_ISRO = 2003,			// Objekteigenschaft ist schreibgeschützt
...
// Fehler
	EC_FAIL = E_FAIL,		// generic error
	EC_UNEXPECTED = E_UNEXPECTED,
	...
	EC_BADKAL = -205,	// Falscher Verweis in die KAL
	EC_BADSPL = -207,	// Falscher Verweis in die SPL
	...
	EC_VERSION = -703,	// Falsche GeoDB-Version
	...
	EC_ACCESS = -720,	// fehlende bzw. zu geringe Zugriffsrechte
	...
	EC_COMPOUNDFILE = -732,		// GeoDB ist CompoundFile
	EC_NOTAPROJECT = -733,		// keine GeoDB oder falsche DBVersion
