/**
 **	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imvfbhist.c,v 1.9 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imvfbhist.c,v 1.9 1995/06/29 00:28:04 bduggan Exp $"
...
#endif
{
	...
	if ( field & IMHUE )
	{
		data[IMMINIMUM] *= (float)((360.0/1023.0));
		data[IMMAXIMUM] *= (float)((360.0/1023.0));
	}
