...
#define D_PF				D_PF1
#else						/* }{ USE_DLIB */
#define D_PF1(fmt,exp)   			/* nothing */
#define D_PF2(fmt1,exp1,fmt2,exp2)		/* nothing */
#define D_PF3(fmt1,exp1,fmt2,exp2,fmt3,exp3)		/* nothing */
#define D_PF4(fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4)	/* nothing */
#define D_PF5(fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4,fmt5,exp5)	/* nothing */
#define D_PF				D_PF1
#endif						/* } USE_DLIB */
...
#define D_SF				D_SF1
#else						/* }{ USE_DLIB */
#define D_SF1(fmt,exp)   			/* nothing */
#define D_SF2(fmt1,exp1,fmt2,exp2)		/* nothing */
#define D_SF3(fmt1,exp1,fmt2,exp2,fmt3,exp3)		/* nothing */
#define D_SF4(fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4)	/* nothing */
#define D_SF5(fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4,fmt5,exp5)	/* nothing */
#define D_SF				D_SF1
#endif						/* } USE_DLIB */
...
#else						/* }{ USE_DLIB */
#define D_PRINTF1(level,fmt,exp)			/* nothing */
#define D_PRINTF2(level,fmt1,exp1,fmt2,exp2)		/* nothing */
#define D_PRINTF3(level,fmt1,exp1,fmt2,exp2,fmt3,exp3)		/* nothing */
#define D_PRINTF4(level,fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4)	/* nothing */
#define D_PRINTF5(level,fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4,fmt5,exp5) /* nothing */
#define D_PRINTF			D_PRINTF1
#endif						/* } USE_DLIB */
...
#define D_OUTF1_EX(file, line, level, fmt, exp) \
	{ D_SUPPORT_ENTER ; \
	if( D_SUPPORT_DOPRINT( file, D_Lib_D_GetD_LibClassName(), level) == 0) \
		{ /* do nothing */  } \
	else \
		D_SUPPORT_FPRINTF1( 1, 0, D_SUPPORT_PREFIX_LEVEL( \
				file, line, \
			...
			"", D_SUPPORT_SPRINTF( fmt, (exp))); \
	D_SUPPORT_LEAVE; }
#define D_OUTF2_EX(file,line,level,fmt1,exp1,fmt2,exp2) \
	{ D_SUPPORT_ENTER ; \
	if( D_SUPPORT_DOPRINT( file, D_Lib_D_GetD_LibClassName(), level) == 0) \
		{ /* do nothing */  } \
	else \
		D_SUPPORT_FPRINTF2( 1, 0, D_SUPPORT_PREFIX_LEVEL( \
			...
			"", D_SUPPORT_SPRINTF( fmt2, (exp2))); \
	D_SUPPORT_LEAVE; }
#define D_OUTF3_EX(file, line, level,fmt1,exp1,fmt2,exp2,fmt3,exp3) \
	{ D_SUPPORT_ENTER ; \
	if( D_SUPPORT_DOPRINT( file, D_Lib_D_GetD_LibClassName(), level) == 0) \
		{ /* do nothing */  } \
	else \
		D_SUPPORT_FPRINTF3( 1, 0, D_SUPPORT_PREFIX_LEVEL( \
			...
			"", D_SUPPORT_SPRINTF( fmt3, (exp3))); \
	D_SUPPORT_LEAVE; }
#define D_OUTF4_EX(file, line, level,fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4) \
	{ D_SUPPORT_ENTER ; \
	if( D_SUPPORT_DOPRINT( file, D_Lib_D_GetD_LibClassName(), level) == 0) \
		{ /* do nothing */  } \
	else \
		D_SUPPORT_FPRINTF4( 1, 0, D_SUPPORT_PREFIX_LEVEL( \
			...
			"", D_SUPPORT_SPRINTF( fmt4, (exp4))); \
	D_SUPPORT_LEAVE; }
#define D_OUTF5_EX(file, line, level,fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4,fmt5,exp5) \
	{ D_SUPPORT_ENTER ; \
	if( D_SUPPORT_DOPRINT( file, D_Lib_D_GetD_LibClassName(), level) == 0) \
		{ /* do nothing */  } \
	else \
	...
	D_SUPPORT_LEAVE; }
#else						/* }{ USE_DLIB */
#define D_OUTF1(level,fmt,exp)			/* nothing */
#define D_OUTF2(level,fmt1,exp1,fmt2,exp2)		/* nothing */
#define D_OUTF3(level,fmt1,exp1,fmt2,exp2,fmt3,exp3)		/* nothing */
#define D_OUTF4(level,fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4)	/* nothing */
#define D_OUTF5(level,fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4,fmt5,exp5) /* nothing */
#define D_OUTF			D_OUTF1
#define D_OUTF1_EX(file,line,level,fmt,exp)
#define D_OUTF2_EX(file,line,level,fmt1,exp1,fmt2,exp2)		/* nothing */
#define D_OUTF3_EX(file,line,level,fmt1,exp1,fmt2,exp2,fmt3,exp3)		/* nothing */
#define D_OUTF4_EX(file,line,level,fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4)	/* nothing */
#define D_OUTF5_EX(file,line,level,fmt1,exp1,fmt2,exp2,fmt3,exp3,fmt4,exp4,fmt5,exp5) /* nothing */
#endif						/* } USE_DLIB */
