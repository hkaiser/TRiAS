...
BEGIN
	...
	"TRiAS Makroprogrammierung, V@A.@B\0"
END
...
//		OBJECT_FUNCTION, "GeometryLinesUnion\0", 395, TYP_APPOBJECT, "GeoObjects\0", 0, 5, TYP_VARIANT, TYP_VARIANT, TYP_VARIANT, TYP_VARIANT, TYP_VARIANT
	...
	// GeoObjectWin
		...
		OBJECT_PROPGET, "Color\0", 476, TYP_LONG, 0, 0
		OBJECT_PROPSET, "Color\0", 477, 1, 1, TYP_LONG
		OBJECT_ENDDEF
...
// last entry used: 477
	...
	// vordefinierte ToolBarButton Konstanten
		...
		TYP_LONG, "Tool59\0", 12068L
		TYP_LONG, "ToolCount\0", 59L
