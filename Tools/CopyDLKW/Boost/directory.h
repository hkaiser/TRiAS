...
namespace boost
{
	namespace filesystem
	{
		...
		class BOOST_DECL dir_it: public std::iterator<std::input_iterator_tag, string>
		{
#if defined(__GNUG__)
			template <class Property>
		...
		class unknown_uid: public invalid_argument
		{
		public:
			unknown_uid(uid_t u): invalid_argument("unknown user ID"), m_uid(u) {}
		...
		{
		public:
			unknown_uname(string u): invalid_argument("unknown user name"), m_uname(u) {}
		...
		{
		public:
			unknown_gname(string g): invalid_argument("unknown group name"), m_gname(g) {}
