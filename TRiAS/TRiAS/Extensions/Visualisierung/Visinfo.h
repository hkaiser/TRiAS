...
EXTERN_C const IID IID_IRawVisInfo;
    ...
    typedef struct IRawVisInfoVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *SetRawData )( 
            IRawVisInfo __RPC_FAR * This,
            /* [in] */ VISINFOTYPE rgType,
            /* [in] */ BSTR Data);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *RetrieveRawData )( 
            IRawVisInfo __RPC_FAR * This,
            /* [in] */ VISINFOTYPE rgType,
    ...
    interface IRawVisInfo
    {
        CONST_VTBL struct IRawVisInfoVtbl __RPC_FAR *lpVtbl;
    };
