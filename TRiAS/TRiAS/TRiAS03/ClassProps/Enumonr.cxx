...
// *** IUnknown methods ***
STDMETHODIMP CEnumObjectNumbers::QueryInterface (REFIID riid, void **ppvObject)
{
// hier lediglich nach IPersistStream fragen
...
// alles andere macht die BasisKlasse
	return SEnumLONG::QueryInterface (riid, ppvObject);
}
...
ULONG ulCnt = m_pEnum->Count();

	LISet32 (*pcbSize, ulCnt * sizeof(LONG) + sizeof(ULONG));
