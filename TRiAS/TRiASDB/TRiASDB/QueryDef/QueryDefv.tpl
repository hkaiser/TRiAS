// VersionsInfoStruktur fuer QueryDef.dll 
// File: QueryDef.rcv
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"TRiAS®-Zusatzmodul QueryDef.\0"
#define VER_INTERNALNAME_STR		"QueryDef\0"
#define VER_ORIGINALFILENAME_STR	"QueryDef.dll\0"
