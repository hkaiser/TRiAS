...
IMTOOLS_API extern int   ImErrNo;			/* Current error number		*/
IMTOOLS_API extern int   ImNErr;			/* Number of error messages	*/
IMTOOLS_API extern char *ImErrList[];		/* List of error messages	*/
...
#if defined(_USE_MMFS_FOR_VFB)
	HANDLE hFile;		// temporary file on disk
	HANDLE hMMF;		// handle to MMF
	char szFile[_MAX_PATH];	// name of the tempfile
#endif // defined(_USE_MMFS_FOR_VFB)
} ImVfb;
...
#define IMCOMPCCITTRLE	(6<<0)	/* CCITTRLE */
#define IMCOMPCCITTFAX3	(7<<0)	/* CCITTFAX3 */
#define IMCOMPCCITTFAX4	(8<<0)	/* CCITTFAX4 */
		/*	(9<<0) - (15<<0)   Reserved			*/
...
#ifdef __STDC__
IMTOOLS_API extern void		 ImPError( char * );
IMTOOLS_API extern char		*ImQError( void );

IMTOOLS_API extern void		 ImRgbToHsi( int[3], float[3] );
IMTOOLS_API extern void		 ImHsiToRgb( float[3], int[3] );

IMTOOLS_API extern ImClt		*ImCltAlloc( int );
IMTOOLS_API extern void		 ImCltFree( ImClt * );
IMTOOLS_API extern ImClt		*ImCltDup( ImClt * );
IMTOOLS_API extern ImClt		*ImCltGrayRamp( ImClt *, int, int, int, int, ImClt * );
IMTOOLS_API extern ImClt		*ImCltRoll( ImClt *, int, ImClt * );

IMTOOLS_API extern ImVfb		*ImVfbAdjust( ImVfb *, int, double, double, int, int, double, double, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbAlloc( int, int, int );
IMTOOLS_API extern ImVfb		*ImVfbClear( int, int, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbComp( ImVfb *, int, int, int, int, int, int, ImVfb *, int, int );
IMTOOLS_API extern ImVfb		*ImVfbCopy( ImVfb *, int, int, int, int, int, ImVfb *, int, int );
IMTOOLS_API extern ImVfb		*ImVfbDup( ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbFade( ImVfb *, double, int, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbFill( ImVfb *, int, int, int, int, int, double, double, int, int, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbFlip( ImVfb *, int, ImVfb * );
IMTOOLS_API extern void		 ImVfbFree( ImVfb * );
IMTOOLS_API extern ImHistTable	*ImVfbHist( ImVfb *, int, int );
IMTOOLS_API extern void		 ImVfbHistTableFree( ImHistTable *  );
IMTOOLS_API extern ImVfb		*ImVfbLightness( ImVfb *, double, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbMix( ImVfb *, double, ImVfb *, double, int, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbResize( ImVfb *, int, ImVfb *, int, int );
IMTOOLS_API extern ImVfb		*ImVfbRoll( ImVfb *, int, int, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbRotate( ImVfb *, double, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfb90Rotate( ImVfb *, ImVfb * );
IMTOOLS_API extern float		*ImVfbStat( ImVfb *, int, float * );
IMTOOLS_API extern ImVfb		*ImVfbToIndex( ImVfb *, int, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbToIndex8( ImVfb *, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbToIndex16( ImVfb *, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbToMono( ImVfb *, int, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbFSDitherToMono( ImVfb *, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbToRgb( ImVfb *, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbToGray( ImVfb *, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbXShear( ImVfb *, double, ImVfb * );
IMTOOLS_API extern ImVfb		*ImVfbYShear( ImVfb *, double, ImVfb * );
IMTOOLS_API extern void		 ImVfbPrint( FILE*, int, ImVfb* );
IMTOOLS_API extern ImVfb 		*ImVfbCopyChannel( ImVfb* inVfb, int inFieldMask, ImVfb* outVfb, int outFieldMask);


IMTOOLS_API extern int		 ImFileRead( int, char *, TagTable *, TagTable * );
IMTOOLS_API extern int		 ImFileFRead( FILE *, char *, TagTable *, TagTable * );
IMTOOLS_API extern int		 ImFileWrite( int, char *, TagTable *, TagTable * );
IMTOOLS_API extern int		 ImFileFWrite( FILE *, char *, TagTable *, TagTable * );
IMTOOLS_API extern char		*ImFileQFormat( int, char * );
IMTOOLS_API extern char		*ImFileQFFormat( FILE *, char * );
IMTOOLS_API extern int		 ImFileQNFormat( void );
IMTOOLS_API extern int		 ImFileFormatOptions( int, ArgOption *, ArgOption ** );
IMTOOLS_API extern int		 ImFileFormatEquivs( int, ArgEquiv *, ArgEquiv ** );
IMTOOLS_API extern ImFileFormat    **ImFileFindFormat( char * );
IMTOOLS_API extern char		*ImFileQCompression(int , TagTable* );
IMTOOLS_API extern char		*ImFileQFCompression(FILE* , TagTable* );
IMTOOLS_API ImCompressScheme 	*ImFileFindCompressionScheme( char* );

IMTOOLS_API extern ImFileFormat    **ImGetFileFormats( void );
IMTOOLS_API extern ImCompressScheme**ImGetCompressSchemes( void );	
