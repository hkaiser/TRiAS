...
public:
    ...
    void SetURL(CString strURL);		// wird auch als Tooltip angezeigt
    CString GetURL() const;

    void SetURLEx(CString strURL);		// wird nur gesendet
    CString GetURLEx() const;
...
protected:
    ...
    CString  m_strURL;                              // hyperlink URL (tooltip only)
    CString  m_strURLEx;                            // hyperlink URL (extended)
