...
TCHAR cbBuffer[_MAX_PATH];
	...
	::GetModuleFileName (g_hInstance, cbBuffer, _MAX_PATH);
	strPathName = cbBuffer;
...
TCHAR szTRiASKey[_MAX_PATH];
	...
	if (!IsWin32s()) {
	// \HKEY_CURRENT_USER\Software\uve\TRiAS\Extensions\...
		wsprintf (szTRiASKey, TEXT("Software\\uve\\TRiAS\\Extensions") TEXT("\\%s"), pszProgID);
	...
	// \HKEY_CURRENT_USER\Software\uve\TRiAS\Extensions\ProgID\Config\...
...
// \HKEY_CURRENT_USER\Software\uve\TRiAS\Extensions\...
	...
	// nur löschen, wenn keine andere Version dieser Erweiterung installiert ist
		wsprintf (szKey, TEXT("Software\\uve\\TRiAS\\Extensions") TEXT("\\%s"), pszProgID);
	...
	// wenn noch subkeys da sind, dann macht diese Funktion garnichts.
		RegDeleteKey (HKEY_CURRENT_USER, TEXT("Software\\uve\\TRiAS\\Extensions"));
	} 
#endif
...
string strKey = pszProgID;
	...
	if (!IsWin32s()) {
	// \HKEY_CURRENT_USER\Software\uve\TRiAS\Extensions\...
		wsprintf (szKey, TEXT("Software\\uve\\TRiAS\\Extensions") 
