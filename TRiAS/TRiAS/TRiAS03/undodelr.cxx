// Undo/Redo für Relation löschen ---------------------------------------------
// File: UNDODELR.CXX
...
BOOL CUndoRedoDeleteObjectRelation::FInit (HOBJECT lONr, HOBJECT lSecONr, HRELATION ulRCode, short iRTyp)
{
...
STDMETHODIMP_(DWORD) CUndoRedoDeleteObjectRelation::Capabilities (signed char **pDesc)
{
...
{
	return FInit (lONr, lSecONr, ulRCode, iRTyp) ? S_OK : ResultFromScode (S_FALSE);
}
