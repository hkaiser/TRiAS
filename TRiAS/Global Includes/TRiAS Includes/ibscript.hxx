...
// *** IExtendBScript methods
	...
	STDMETHOD(RunTextEx)(THIS_ LPCSTR lpText, LPCSTR lpName, LPCSTR lpEntry, int iNumParams, struct tagBSPARAM *pPars, BOOL fBreakAfterExec, INT_PTR hPrCtx) PURE;
	STDMETHOD(RunCodeEx)(THIS_ HINSTANCE hInst, int iResID, LPCSTR lpName, LPCSTR lpEntry, int iNumParams, struct tagBSPARAM *pPars, BOOL fBreakAfterExec, INT_PTR hPrCtx) PURE;
	STDMETHOD(ExecuteMethod)(THIS_ LPCSTR lpName, LPCSTR lpEntry, int iNumParams, struct tagBSPARAM *pPars, BOOL fBreakAfterExec, INT_PTR hPrCtx) PURE;

	STDMETHOD(EntryExists)(THIS_ LPCSTR lpEntry, int iNumParams, struct tagBSPARAM *pPars) PURE;
};
