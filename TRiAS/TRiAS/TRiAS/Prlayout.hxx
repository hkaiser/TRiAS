...
// ein LegendenEintrag
	bool KastenFont (int &iFam, string &strName, int &iSizeY, bool &fB, bool &fI, bool &fU);
...
// ZwischenÜberschriften
	bool ZwischenUeberschriftFont (int &iFam, string &strName, int &iSizeY, bool &fB, bool &fI, bool &fU);
	long ZwischenUeberschriftVorHoehe (long lDefault);
	long ZwischenUeberschriftNachHoehe (long lDefault);
