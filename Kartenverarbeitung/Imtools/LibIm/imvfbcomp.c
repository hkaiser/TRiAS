/**
 **	$Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imvfbcomp.c,v 1.16 1995/06/29 00:28:04 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/image/imtools/v3.0/libim/src/RCS/imvfbcomp.c,v 1.16 1995/06/29 00:28:04 bduggan Exp $"
...
#endif
{
        ...
        if ( (bgYInto + i) < bgYSize )
	{
	    ...
	    {
		alpha1 = (float)(ImVfbQAlpha( fgVfb, pFg )/255.0);
		...
		if ( fieldMask & (IMHUE | IMSATURATION | IMINTENSITY) )
		{
			...
			if ( fieldMask & IMHUE )
				hsi2[0] = (float)(hsi1[0] * alpha1 + hsi2[0] * (1.0 - alpha1));
			if ( fieldMask & IMSATURATION )
				hsi2[1] = (float)(hsi1[1] * alpha1 + hsi2[1] * (1.0 - alpha1));
			if ( fieldMask & IMINTENSITY )
				hsi2[2] = (float)(hsi1[2] * alpha1 + hsi2[2] * (1.0 - alpha1));
...
#endif
{
	 ...
	 * overlaps of the left and lower end of the background, it is cut off.
        ...
        if ( (bgYInto + i) < bgYSize )
        {
            ...
            {
		alpha1 = (float)(ImVfbQAlpha( fgVfb, pFg )/255.0);
		alpha2 = (float)(ImVfbQAlpha( bgVfb, pBg )/255.0);
		...
		if ( fieldMask & (IMHUE | IMSATURATION | IMINTENSITY) )
		{
			...
			if ( fieldMask & IMHUE )
				hsi2[0] = (float)(hsi1[0] * alpha2 + hsi2[0] * (1.0 - alpha1));
			if ( fieldMask & IMSATURATION )
				hsi2[1] = (float)(hsi1[1] * alpha2 + hsi2[1] * (1.0 - alpha1));
			if ( fieldMask & IMINTENSITY )
				hsi2[2] = (float)(hsi1[2] * alpha2 + hsi2[2] * (1.0 - alpha1));
...
#endif
{
	 ...
	 * overlaps of the left and lower end of the background, it is cut off.
		...
		if ( fieldMask & (IMHUE | IMSATURATION | IMINTENSITY) )
		{
			...
			if ( fieldMask & IMHUE )
				hsi2[0] = (float)(hsi1[0] * (1.0 - alpha2));
			if ( fieldMask & IMSATURATION )
				hsi2[1] = (float)(hsi1[1] * (1.0 - alpha2));
			if ( fieldMask & IMINTENSITY )
				hsi2[2] = (float)(hsi1[2] * (1.0 - alpha2));
