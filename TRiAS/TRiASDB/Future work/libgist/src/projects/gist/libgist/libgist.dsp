...
# ADD CPP /nologo /MD /W3 /WX /GX /Zi /O2 /I "$(LIBGISTHOME)\include" /D "NDEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /YX /Fd"Release/libgist.pdb" /FD /TP /c
...
# ADD CPP /nologo /MDd /W3 /WX /Gm /GX /Zi /Od /I "$(LIBGISTHOME)\include" /D "_LIB" /D "_DEBUG" /D "WIN32" /D "_MBCS" /Fp"Debug/libgistd.pch" /YX /Fd"Debug/libgistd.pdb" /FD /GZ /TP /c
...
LIB32=xilink6.exe -lib
# ADD BASE LIB32 /nologo
# ADD LIB32 /nologo /out:"..\..\..\..\lib\libgistd.lib"
# Begin Custom Build
OutDir=.\Debug
TargetPath=\Download\C++\Geometry\libgist\lib\libgistd.lib
TargetName=libgistd
InputPath=\Download\C++\Geometry\libgist\lib\libgistd.lib
SOURCE="$(InputPath)"
