///////////////////////////////
// Bug fixed version of ATLDB.H
// No new features in this file to keep it compatible with the original
// It is based on ATLDB.H as found in Microsoft Visual C++ 6.0 SP3
//
// Known issues:
// - Not multithread safe. A lot of fixes required.
// - GetPropertyInfo is not working correctly for custom prop sets in any of the DBPROPSET_*ALL groups
// - Check how IConvertTypeImpl works with variants. See MS flag _LATER.

// History:
// 2000-02-15 MRD applied fixes to custom property set support resulting
//				from buggy operation of IDBPropertiesImpl::GetProperties.
//
// 2000-02-14 Added Mark Dawson's fixes for custom property sets. This affects:
//				CUtlPropsBase::GetSupportedSetsInGroup (new, added)
//				IDBPropertiesImpl::GetProperties, SetProperties
//				IDBSchemaRowsetImpl::InternalCreateSchemaRowset
//				IDBOpenRowsetImpl::CreateRowset
//				ICommandPropertiesImpl::GetProperties, SetProperties
//				ISessionPropertiesImpl::GetProperties, SetProperties
//				IRowsetInfoImpl::GetProperties
// 2000-02-14 Added Brad Schmitt's fixed version of IDBProperyInfo::GetPropertyInfo
//				This fix overwrites the fix to GetPropertyInfo listed above.
//				Commented out hardcoded property set, you'll have to manually change this yourself
// 2000-02-14 Added Sergey Samsonik fix for prevent loss of session properties in 
//				IDBSchemaRowsetImpl::CreateSchemaRowset
//
// 2000-01-16/TO First post of this fixed ATLDB.H.
//	 Fixes to *_Flags that where marked with the wrong property set flag
//	 Fix to GetPropertyInfo when used with custom property sets. Probably need more work.
//	 Fixes found in http://support.microsoft.com/download/support/mslfiles/Atldbfix.exe
//	 Added DBCONVERTFLAGS_FROMVARIANT to IConvertTypeImpl. Needs more testing.
//	 Fixed crash in GetBindings if the resulting bind count was 0
//

#ifndef __ATLDB_H
#define __ATLDB_H

#pragma once // !!2000-01-16/TO
...
#define ABORTPRESERVE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )	// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
...
#define BOOKMARKS_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )				// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define BOOKMARKSKIPPED_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define BOOKMARKTYPE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )	// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
...
#define CANFETCHBACKWARDS_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ | DBPROPFLAGS_WRITE )	// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define CANHOLDROWS_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ | DBPROPFLAGS_WRITE ) 					// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define CANSCROLLBACKWARDS_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ | DBPROPFLAGS_WRITE )	// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
...
#define COLUMNRESTRICT_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )							// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define COMMANDTIMEOUT_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ | DBPROPFLAGS_WRITE )
#define COMMITPRESERVE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )							// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
...
#define LITERALIDENTITY_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define MAXINDEXSIZE_Flags ( DBPROPFLAGS_DATASOURCEINFO | DBPROPFLAGS_READ )
#define MAXOPENROWS_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 			// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define MAXPENDINGROWS_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )	// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
...
#define NOTIFICATIONPHASES_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )				// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYCOLUMNSET_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 				// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWDELETE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 				// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWFIRSTCHANGE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )	  // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWINSERT_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 				// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWRESYNCH_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ )			   // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWSETRELEASE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 			 // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWSETFETCHPOSITIONCHANGE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 	 // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWUNDOCHANGE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 			 // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWUNDODELETE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 			 // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWUNDOINSERT_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 			 // !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
#define NOTIFYROWUPDATE_Flags ( DBPROPFLAGS_ROWSET | DBPROPFLAGS_READ ) 				// !!2000-01-16/TO Was DBPROPFLAGS_DATASOURCEINFO
...
// #HK010717: ADDED BEGIN
			if (NULL != pdbidSrc->uName.pwszName) {
// #HK010717: ADDED END
...
public:
	CPropColID()
	{
		// #HK010518: ADDED BEGIN
		memset (&dbidProperty, '\0', sizeof(DBID));
		dwOption = 0;
		// #HK010518: ADDED END
		VariantInit(&vValue);
	}
	...
	// #HK010518: ADDED BEGIN
	CPropColID (const CPropColID &rhs)
	{
		memset (&dbidProperty, '\0', sizeof(DBID));
		VariantInit (&vValue);
		
		CopyDBIDs(&dbidProperty, &rhs.dbidProperty);
		dwOption = rhs.dwOption;
		VariantCopy (&vValue, const_cast<VARIANT *>(&rhs.vValue));
	}
	CPropColID & operator= (const CPropColID &rhs)
	{
		if (this != &rhs) {
			FreeDBIDs(&dbidProperty);
			VariantClear(&vValue);
...
public:
	...
	ULONG CalcDescripBuffers(ULONG cPropInfoSet, DBPROPINFOSET* pPropInfoSet)
	{
		...
		for(ULONG ulSet=0; ulSet<cPropInfoSet; ulSet++)
		{
			...
			{
				// NB! Changed!
				// Should check pPropInfoSet->cPropertyInfos
				// and loop through all m_pUPropSet[m_rgiPropSetDex[]] elements
				// only if pPropInfoSet->cPropertyInfos is 0, otherwise use its value
...
EXIT:
		...
		const GUID* pGuid = NULL)
	{
		...
		if ( cPropertySets == 0 )
		{
			...
			{
			/*
			* AOD - If the GUID is one of the "special" property sets that is
			*		 one of the DBPROPSET_*ALL property sets (e.g.
			*		 DBPROPSET_DBINITALL) which will cause this function to
			*		 return more than one property set if there are provider
			*		 specific property sets created for that property group.
			*		 For ADS, we added a DBINIT property set.  So if the
			*		 DBPROPSET_DBINITALL prop set is passed in, we'll
			*		 return back info about two prop sets, DBPROPSET_DBINIT and
			*		 DBPROPSET_ADSDBINIT.  So calculate the number of prop
			*		 sets to get accordingly.
				*/
				// cSets = 1;
				if ( GetPropertySetIndex( pGuid ) == S_OK )
					// AOD comment - The prop set was found.  If this was one of
					// the special *ALL GUIDs, there could be more than 1 prop set
					cSets = m_cPropSetDex;
				else
					// AOD comment - No prop sets were found.  Later code will error out.
					cSets = 1;
				
					/*
					* AOD - Set this value to one so we only go through the loop
					*		 below once.  We may be getting multiple prop sets,
					*		 but we only want to go through the loop once since
					*		 a single GUID was specified.
				*/
				cTimesThroughLoop = 1;
			}
			else
			{
				// AOD comment - Get all the prop sets for this CoType (e.g. all
				// prop sets relating to a DS object somehow).	We will loop once
				// below for every individual prop set available.
				cSets = m_cUPropSet;
				cTimesThroughLoop = m_cUPropSet;
			}
		}
		else
		{
			...
			for ( ulSet=0; ulSet<cPropertySets; ulSet++ )
			{
				if (GetPropertySetIndex(&(rgPropertySets[ulSet].guidPropertySet)) == S_OK )
					// AOD comment - The prop set was found.  If this was one of the
					// special *ALL GUIDs, there could be more than 1 prop set
					cSets += m_cPropSetDex;
				else
					// AOD comment - No prop set was found. Later code will error out.
					cSets++;
			}
		}
		...
		//AOD - Both the pre-SP3 and SP3 code were wrong for this next
		//	  statement.  With GetPropertyInfo, it's legal to
		//	  pass in one "special" property set that is one of the
		//	  DBPROPSET_*ALL property sets (e.g. DBPROPSET_DBINITALL) which
		//	  will cause this function to return more than one property set
		//	  if there are provider specific property sets created for
		//	  that property group.	For ADS, we added a DBINIT property set.
		//	  So if the DBPROPSET_DBINITALL prop set is passed in, we'll
		//	  return back info about two prop sets, DBPROPSET_DBINIT and
		//	  DBPROPSET_ADSDBINIT.	In the code below, ulSet is used to
		//	  index into the rgPropertySets array.	We can't allow
		//	  the loop counter, ulSet, to be greater than cPropertySets
		//	  if cPropertySets is greater than 0.
		//AOD// VC 6.0 ulEnd = cPropertySets == 0 ? cSets : cPropertySets;
		//AOD  ulEnd = cSets; // VC 6.0 SP3
		ulEnd = cPropertySets == 0 ? cTimesThroughLoop : cPropertySets;
...
// #HK010624: ADDED END
						...
						GetPropertySetIndex(&guidSet) == S_OK )
					{
						...
						{
							// AOD comment - This is one of the special *ALL GUIDs.
							// Store the GUIDs and init the number of props for this
							// GUID to 0
							ATLASSERT( ulOutIndex < cSets ); //AOD
							pPropInfoSet[ulOutIndex].guidPropertySet = *(m_pUPropSet[m_rgiPropSetDex[ul]].pPropSet);
							pPropInfoSet[ulOutIndex].cPropertyInfos  = 0;
							//AOD ulIndex = m_rgiPropSetDex[ul];
						}
					}
					else
					{
						//AOD comment - There should be just one prop set to return
						ATLASSERT( cSets == 1 ); //AOD
						
						for (ULONG l=0; l<m_cUPropSet; l++)
						{
							if ( InlineIsEqualGUID(*m_pUPropSet[l].pPropSet, *pGuid))
								// AOD comment - We found the one prop set to be valid.
								// Set the ulIndex equal to the offset in m_puPropSet
								//ulIndex = l;
								break;  //AOD
						}
						...
						ATLASSERT( ulSet < cSets ); //AOD
						
						// AOD comment - Store the GUID
						pPropInfoSet[ulSet].guidPropertySet = *pGuid;
					}
				}
				else
				{
					// AOD comment - We're going to get all prop sets for every
					// property set in this property "collection" one at a time.
					//  We'll be going through this for loop ulEnd times.
					ATLASSERT( ulSet < cSets ); //AOD
...
// #HK010624: ADDED END
					...
					GetPropertySetIndex(&guidSet) == S_OK )
				{
					for ( ul=0; ul<m_cPropSetDex; ul++,ulOutIndex++ )
					{
						...
						// AOD comment - This is one of the special *ALL GUIDs.Store
						// the GUIDs and init the number of props for this GUID to 0
						pPropInfoSet[ulOutIndex].guidPropertySet	  = *(m_pUPropSet[m_rgiPropSetDex[ul]].pPropSet);
						pPropInfoSet[ulOutIndex].cPropertyInfos	  = 0;
					}
				}
				else
				{
					...
					// AOD comment - Store the GUID and the prop IDs passed into this
					// function for this non-special *ALL GUID.
		...
		for ( ulSet=0; ulSet<cSets; ulSet++ )
		{
			...
			{
			/*
			* AOD - Hopefully fixed a bug without breaking anything.  The whole
			* ulIndex stuff doesn't work right if you have a custom property that
			* makes one of the special *ALL GUIDs return 2 prop sets rather than 1.
			* GetPropertySetIndex should verify our property set and set
			* up the m_rgiPropSetDex[0] and m_cPropSetDex for us like we wanted
			* in the first place
				*/
				if ( GetPropertySetIndex( &(pPropInfoSet[ulSet].guidPropertySet)) == S_OK )
				{
					// Should return 1 prop set because we already divided up the
					// special *ALL prop sets above.  Should also set up the
					// m_rgiPropSetDex[0] and m_cPropSetDex for us.
				...
				//AOD			 ULONG ulTempSet;
				//AOD			 if ( pGuid != NULL )
				//AOD				ulTempSet = ulIndex;
				//AOD			 else
				//AOD				ulTempSet = ulSet;
				//AOD			 cPropInfos = m_pUPropSet[ulTempSet].cUPropInfo;
				dwStatus |= GETPROPINFO_ALLPROPIDS;
				//AOD			 m_rgiPropSetDex[0] = ulTempSet;
				//AOD			 m_cPropSetDex = 1;
			}
			else
			{
				...
				if ( pPropInfoSet[ulSet].cPropertyInfos == 0 )
				{
					...
					if (GetPropertySetIndex(&(pPropInfoSet[ulSet].guidPropertySet)) == S_OK )
					{
						// AOD comment - Should return 1 prop set because we already
						// divided up the special *ALL prop sets above
						ATLASSERT( m_cPropSetDex == 1 );
						
						ATLASSERT( cPropInfos == 0 ); //AOD - why is below a '+='? Could be just a '='?
				...
				else
				{
					...
					if ((GetPropertySetIndex(&(pPropInfoSet[ulSet].guidPropertySet)) == S_FALSE)
						...
						//						  !( InlineIsEqualGUID(pPropInfoSet[ulSet].guidPropertySet, DBPROPSET_ADSDBINIT )) &&
			...
			if ( pPropInfo )
			{
				...
				for ( ULONG ulProp=0; ulProp<cPropInfos; ulProp++ )
				{
					...
					if ( dwStatus & GETPROPINFO_NOTSUPPORTED )
					{
						...
						ATLASSERT( ulSet < cPropertySets ); //AOD
						//AOD - for lack of a better way to work around this bug
						if ( ulSet >= cPropertySets )
							pPropInfo[ulProp].dwPropertyID = rgPropertySets[cPropertySets-1].rgPropertyIDs[ulProp];
						else
				...
				for ( ul=0; ul<m_cPropSetDex; ul++ )
				{
					...
					else
					{
						...
						for ( ulProp = 0; ulProp < cPropInfos; ulProp++, ulNext++)
						{
							...
							//AOD - for lack of a better way to work around this bug
							if ( ulSet >= cPropertySets )
								pCurPropInfo->dwPropertyID = rgPropertySets[cPropertySets-1].rgPropertyIDs[ulProp];
							else
...
// #HK010626: ADDED BEGIN
	virtual DWORD GetSupportedSetsInSpecialGroup(REFGUID rGuid)
	{
		return 0;
	}
// #HK010626: ADDED END
	// MRD - Implemented to allow interface implementations
	// (such as IOpenRowsetImpl) to support custom property sets
	ULONG GetSupportedSetsInGroup(const ULONG ulGroups, const GUID** pGroup, const GUID*** ppSets)
	{
		DWORD	dwFlag = 0;
		ULONG	nSets = 0;
		
		ATLASSERT(ppSets != NULL);
		ATLASSERT(pGroup != NULL);
		
		if(ppSets == NULL)
			return 0;
		
		for(ULONG nGroup = 0; nGroup < ulGroups; nGroup++)
		{
			if(InlineIsEqualGUID(*(pGroup[nGroup]), DBPROPSET_DATASOURCEALL))
			{
				dwFlag |= DBPROPFLAGS_DATASOURCE;
			}
			else if(InlineIsEqualGUID(*(pGroup[nGroup]), DBPROPSET_DATASOURCEINFOALL))
			{
				dwFlag |= DBPROPFLAGS_DATASOURCEINFO;
			}
			else if(InlineIsEqualGUID(*(pGroup[nGroup]), DBPROPSET_ROWSETALL))
			{
				dwFlag |= DBPROPFLAGS_ROWSET;
			}
			else if(InlineIsEqualGUID(*(pGroup[nGroup]),DBPROPSET_DBINITALL))
			{
				dwFlag |= DBPROPFLAGS_DBINIT;
			}
			else if(InlineIsEqualGUID(*(pGroup[nGroup]),DBPROPSET_SESSIONALL))
			{
				dwFlag |= DBPROPFLAGS_SESSION;
			}
// #HK010624: ADDED BEGIN
			else if(InlineIsEqualGUID(*(pGroup[nGroup]),DBPROPSET_COLUMNALL))
			{
				dwFlag |= DBPROPFLAGS_COLUMN;
			}
			else if(InlineIsEqualGUID(*(pGroup[nGroup]),DBPROPSET_INDEXALL))
			{
				dwFlag |= DBPROPFLAGS_INDEX;
			}
			else if(InlineIsEqualGUID(*(pGroup[nGroup]),DBPROPSET_TABLEALL))
			{
				dwFlag |= DBPROPFLAGS_TABLE;
			}
			else if(InlineIsEqualGUID(*(pGroup[nGroup]),DBPROPSET_TRUSTEEALL))
			{
				dwFlag |= DBPROPFLAGS_TRUSTEE;
			}
			else if(InlineIsEqualGUID(*(pGroup[nGroup]),DBPROPSET_VIEWALL))
			{
				dwFlag |= DBPROPFLAGS_VIEW;
			}
			else
				dwFlag |= GetSupportedSetsInSpecialGroup(*(pGroup[nGroup]));
// #HK010624: ADDED END
		}
		
		// Scan through the property sets looking for matching attributes
		for(ULONG nIx = 0; nIx < m_cUPropSet; nIx++)
		{
			if(m_pUPropSet[nIx].pUPropInfo[0].dwFlags & dwFlag)
				nSets++;
		}
		
		if(nSets == 0)
			return 0;	//None supported
		
		//Create an array to store the property sets in
		*ppSets = (const GUID**)CoTaskMemAlloc(nSets * sizeof(const GUID*));
		if(*ppSets == NULL)
			return 0;
		
		//Now populate the GUID buffer with the matching property sets
		ULONG nCnt;
		
		for(nCnt = 0, nIx = 0; (nIx < m_cUPropSet) && (nCnt < nSets); nIx++)
		{
			if(m_pUPropSet[nIx].pUPropInfo[0].dwFlags & dwFlag)
				(*ppSets)[nCnt++] = m_pUPropSet[nIx].pPropSet;
		}
						  ...
						  const ULONG cSelectProps = 1, const GUID** ppGuid = NULL)
	{
		...
		for(ulSet=0; ulSet<cSets; ulSet++)
		{
			...
			if( pProp )
			{
				...
				// #HK010518: CHANGED BEGIN
				//				for(ulProp=0; ulProp<cProps; ulProp++)
				for(ulProp=0; ulNext < cProps; ulProp++)
					// #HK010518: CHANGED END
				{
	...
	//		(*pulNext)++;
	//	}
	void RetrieveColumnIdProps(DBPROP* pBaseProp, UPROPVAL* pUPropVal, ULONG* pulNext)
	{
		// Reset to first Node
		CColumnIds* pColIds = pUPropVal->pCColumnIds;
		DBPROPID dwPropertyID = pBaseProp[*pulNext].dwPropertyID;
		DBPROP *pCurProp = &(pBaseProp[++(*pulNext)]);
		HRESULT hr = E_FAIL;
		...
		for (int i = 0; i < pColIds->GetSize(); i++)
		{
			...
			if (SUCCEEDED(hr))
				pCurProp = &(pBaseProp[++(*pulNext)]);
		}
		if (0 == pColIds->GetSize())
			(*pulNext)++;
	}
	// #HK010518: CHANGED END
		...
		DBPROPSET **prgProperties)
	{
		...
		if(SUCCEEDED(hr))
		{
			...
			for (ULONG i=0; i<cPropertySets; i++)
			{
				if (InlineIsEqualGUID(rgPropertySets[i].guidPropertySet, DBPROPSET_PROPERTIESINERROR))
					...
					// CHANGED: #HK010508, DBInitialize testcase
					if (*pcProperties != 0 || *prgProperties != NULL || cPropertySets > 1)
						return E_INVALIDARG;
			}
		}
		...
		if (SUCCEEDED(hr))
		{
			...
			if (pT->m_dwStatus & DSF_INITIALIZED)
			{
				...
				ppGroups[1] = &DBPROPSET_DATASOURCEALL;
				ppGroups[2] = &DBPROPSET_DATASOURCEINFOALL;
				
				ULONG ulSets = CUtlProps<T>::GetSupportedSetsInGroup(3, ppGroups, &ppGuid);
				hr = CUtlProps<T>::GetProperties(cPropertySets, rgPropertySets,
					pcProperties, prgProperties, ulSets, ppGuid);
			...
			else
			{
				...
				const GUID**	ppGuid = NULL;
				ULONG ulSets = CUtlProps<T>::GetSupportedSetsInGroup(1, pGroup, &ppGuid);
				hr = CUtlProps<T>::GetProperties(cPropertySets, rgPropertySets,
					pcProperties, prgProperties, ulSets, ppGuid);
			}
		}
...
// #HK010523: CHANGED END
				...
				ULONG ulSets = CUtlProps<T>::GetSupportedSetsInGroup(3, ppGroups, &ppGuid);
					...
					hr = CUtlProps<T>::SetProperties(0, cPropertySets, rgPropertySets, ulSets, ppGuid);
					CoTaskMemFree(ppGuid);
...
public:
		...
		IUnknown* pUnkSession)
	{
		...
		if ((pUnkOuter != NULL) && !InlineIsEqualUnknown(riid))
		{
			pUnkThis->AddRef(); 			// MRD - the boys at MS seem to think this necessary
			pUnkThis->Release();	// MRD - the boys at MS seem to think this necessary
			return DB_E_NOAGGREGATION;
		}
		...
		const GUID* pGroup[1];
		pGroup[0] = &DBPROPSET_ROWSETALL;
		const GUID**	ppGuid = NULL;
		ULONG ulSets = pProps->GetSupportedSetsInGroup(1, pGroup, &ppGuid);
...
// #HK010715: ADDED BEGIN LTM test
		if (NULL == prgRest)
			return E_INVALIDARG;
// #HK010715: ADDED END LTM test
...
public:
		...
		RowsetClass*& pRowsetObj)
	{
		...
		pGroup[0] = &DBPROPSET_ROWSETALL;
// #HK010624: ADDED BEGIN
		pGroup[1] = &DBPROPSET_INDEXALL;
// #HK010624: ADDED END
		const GUID**	ppGuid = NULL;
		ULONG ulSets = pRowsetObj->GetSupportedSetsInGroup(2, pGroup, &ppGuid);
		...
		if (InlineIsEqualGUID(riid, IID_NULL))
		{
			...
			if (ppRowset == NULL)
// #HK010718: CHANGED BEGIN
//				return (hrProps == DB_S_ERRORSOCCURRED) ? DB_E_ERRORSOCCURRED : hr;
				return hrProps;
// #HK010718: CHANGED END
...
public:
		...
		bool bIsCommand, bool bHasParamaters, IObjectWithSite* pSite)
	{
		...
		// !!2000-01-16/TO Added DBCONVERTFLAGS_FROMVARIANT
...
public:
		...
		DBPROPSET **prgPropertySets)
	{
		...
		if(SUCCEEDED(hr))
		{
			...
			pGroup[0] = &DBPROPSET_ROWSETALL;
			const GUID**	ppGuid = NULL;
			ULONG ulSets = CUtlProps<PropClass>::GetSupportedSetsInGroup(1, pGroup, &ppGuid);
...
// #HK010715: ADDED BEGIN (LTM test)
			if (0 != (rBindCur.dwMemOwner & ~DBMEMOWNER_PROVIDEROWNED))
			{
			// illegal value for dwMemOwner
				hr = DB_E_ERRORSOCCURRED;
				rgStatus[iBinding] = DBBINDSTATUS_BADBINDINFO;
				continue;
			}
// #HK010715: ADDED BEGIN
...
// #HK010715: CHANGED BEGIN (LTM test)
//					HasFlag(~(DBTYPE_BYREF) & rBindCur.wType, DBTYPE_BSTR);
					((~(DBTYPE_BYREF) & rBindCur.wType) == DBTYPE_BSTR);
// #HK010715: CHANGED END
				if (!bIsPointerType)
				{
					hr = DB_E_ERRORSOCCURRED;
					rgStatus[iBinding] = DBBINDSTATUS_BADBINDINFO;
...
// #HK010715: ADDED BEGIN (LTM test)
			if (0 != (rBindCur.dwFlags & ~DBBINDFLAG_HTML))
			{
			// invalid dwFlags
				hr = DB_E_ERRORSOCCURRED;
				rgStatus[iBinding] = DBBINDSTATUS_BADBINDINFO;
			...
			if (rBindCur.dwFlags == DBBINDFLAG_HTML && 
				!((rBindCur.wType & ~(DBTYPE_ARRAY|DBTYPE_BYREF|DBTYPE_VECTOR)) == DBTYPE_WSTR || 
				  (rBindCur.wType & ~(DBTYPE_ARRAY|DBTYPE_BYREF|DBTYPE_VECTOR)) == DBTYPE_STR || 
				  (rBindCur.wType & ~(DBTYPE_ARRAY|DBTYPE_BYREF|DBTYPE_VECTOR)) == DBTYPE_BSTR
				 )
				)
			{
			// DBBINDFLAG_HTML specified for non string binding
				hr = DB_E_ERRORSOCCURRED;
				rgStatus[iBinding] = DBBINDSTATUS_BADBINDINFO;
				continue;
			}
...
// #HK010716: CHANGED BEGIN (LTM test)
//			return E_INVALIDARG;
			return DB_E_BADACCESSORHANDLE;
// #HK010716: CHANGED END
		}
		if (pcRefCount == NULL)
		...
		DBBINDING **prgBindings)
	{
		...
		if (pdwAccessorFlags != NULL)
			*pdwAccessorFlags = DBACCESSOR_INVALID; 			  // !!2000-01-16/TO Was NULL. This is only an estetic fix
		
		if (pcBindings != NULL)
			*pcBindings = 0; // !!2000-01-16/TO Was NULL. This is only an estetic fix
		...
		if (pBind != NULL)
		{
			...
			*prgBindings = (DBBINDING*)CoTaskMemAlloc(*pcBindings * sizeof(DBBINDING));
			if (*prgBindings == NULL)
				return E_OUTOFMEMORY;
			if (*pcBindings)		// !!2000-01-16/TO Check for zero count
...
// #HK010516: (LPOLESTR)name --> (LPOLESTR)OLESTR(name)
...
public:
	...
	// !!2000-01-16/TO The following fix is from http://support.microsoft.com/download/support/mslfiles/Atldbfix.exe
	//FIX: re-written GetData method which handles provider-owned memory which
	//	   is used by SQL Server whenever the OLE DB Proxy/Stub is required as is the
	//	   case when the SQL Server invokes the provider out-of-process or the provider 
	//		   is invoked by SQL Server and is an apartment model provider (these are the
	//	   default cases)
		...
		void *pDstData)
	{
		...
		bool bOneColumnSuccessful = false;
		...
		for (ULONG iBind =0; iBind < pBinding->cBindings; iBind++)
		{
			...
			{
				// Convert data to wType and set columnsize
				ULONG cbCol;
				...
				if (pBindCur->dwPart & DBPART_VALUE)
				{
					...
					{	
						...
						*((void **)((BYTE*)(pDstData) + pBindCur->obValue)) = (void*)((BYTE*)(pSrcData) + pColCur->cbOffset);
					}
					else
					{
						...
						// All conversions should be possible otherwise an error would have occurred
						// when creating the accessor. Therefore, we must have a fatal error. 
						if (FAILED(hr))
							bErrorsOccurred = true;
						else 
							bOneColumnSuccessful = true;
			...
			if (pBindCur->dwPart & DBPART_LENGTH)
			{
				*((ULONG*)((BYTE*)(pDstData) + pBindCur->obLength)) = cbDst;
				//				cbDst = *((ULONG*)((BYTE*)(pDstData) + pBindCur->obLength));
			}
		...
		if (bErrorsOccurred && bOneColumnSuccessful)
			return DB_S_ERRORSOCCURRED;
		else
			if (bErrorsOccurred && !bOneColumnSuccessful)
				return DB_E_ERRORSOCCURRED;
...
// #HK010719: ADDED BEGIN
		bool fNoDetachOnError = false;
// #HK010719: ADDED END
		if (*prghRows == NULL)
		{
...
// #HK010719: CHANGED BEGIN
//		if (SUCCEEDED(hr))
//			amr.Detach();
		if (fNoDetachOnError) {
			if (S_OK == hr || (SUCCEEDED(hr) && 0 != *pcRowsObtained))
				amr.Detach();
			else
				*prghRows = NULL;
		} 
// #HK010719: CHANGED END
		return hr;
	}
...
// #HK010624: ADDED END
			const GUID**	ppGuid = NULL;
			ULONG ulSets = CUtlProps<PropClass>::GetSupportedSetsInGroup(2, pGroup, &ppGuid);
			hr = CUtlProps<PropClass>::GetProperties(cPropertyIDSets,
				rgPropertyIDSets, pcPropertySets, prgPropertySets,
				ulSets, ppGuid);
		}
