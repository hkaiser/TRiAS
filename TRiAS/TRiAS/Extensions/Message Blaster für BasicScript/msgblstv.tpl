// VersionsInfoStruktur für MSGBLAST.EXT ---------------------------------------
// File: MSGBLAST.RCV
...
#define VER_LEGALCOPYRIGHT_STR	"Copyright © Fernerkundungszentrum Potsdam GmbH 1991 - 1998, #@D\0"
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"Zusätzliche Objekte für BasicScript.\0"
#define VER_INTERNALNAME_STR		"MSGBLAST\0"
#define VER_ORIGINALFILENAME_STR	"MSGBLAST.EXT\0"
