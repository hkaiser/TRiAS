...
/**
 * Defaukt initial index size (number of objects)
 */
...
class FASTDB_DLL_ENTRY dbDatabase { 
  ...
  public:
     ...
     * @return currently allocated size (it can be larger than size of the file)
     */
  ...
  protected:
     ...
     * @param table descriptor of table to which recoprd belongs
     * @param cursor result set
     ...
     * @param size eof allocated object
     * @return oid of allocated object
     */
...
class dbReplicatedDatabase : public dbDatabase {
    friend class dbFile;
  protected:
    char**        serverURL;
    int           nServers;
