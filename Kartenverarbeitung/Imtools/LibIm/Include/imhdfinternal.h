 ...
 */
IMTOOLS_API extern int imHdfByteOrder;		/* Default byte order		*/
IMTOOLS_API extern int imHdfFloatFormat;		/* Default float format		*/
IMTOOLS_API extern sdsc_uint16 imHdfRef;		/* Current reference number	*/
...
#ifdef __STDC__
IMTOOLS_API extern void imHdfDDEmpty(void );
IMTOOLS_API extern imHdfDD *imHdfDDAppend(unsigned int tag, unsigned int ref, long dataOffset, long dataLength );
IMTOOLS_API extern imHdfDD *imHdfDDFind(unsigned int tag, unsigned int ref  );

IMTOOLS_API extern void imHdfCltEmpty( void );
IMTOOLS_API extern imHdfClt *imHdfCltAppend( ImClt* clt, unsigned int refLUT, unsigned int refLD);
IMTOOLS_API extern imHdfClt *imHdfCltFind( ImClt * clt );
IMTOOLS_API extern imHdfClt *imHdfCltFindRef( unsigned int ref);
#else
