// VersionsInfoStruktur fuer OLEAUTO.EXT ---------------------------------------
// File: OLEAUTO.RCV
...
#define VER_LEGALCOPYRIGHT_STR	"Copyright © Hartmut Kaiser 1991 - 2005, #@D\0"
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"TRiAS® OLE-Automation Server.\0"
#define VER_INTERNALNAME_STR		"OLEAUTO\0"
#define VER_ORIGINALFILENAME_STR	"OLEAUTO.EXT\0"
...
BEGIN
	...
	//
	// Diese TRiAS-Erweiterung registriert sich selbst
	//
