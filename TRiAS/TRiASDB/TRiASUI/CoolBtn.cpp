...
CCoolBtn::CCoolBtn()
{
	...
	m_menu.LoadMenu(IDR_TREE_POPUPMENU);
}
...
UINT uiCmd = pSubMenu -> TrackPopupMenu(TPM_RIGHTALIGN | TPM_LEFTBUTTON | TPM_NONOTIFY | TPM_RETURNCMD, rc.right, rc.bottom, GetParent());
