// VersionsInfoStruktur fuer GdbAsc.EXE ------------------------------------------
// File: GdbAsc.RCV
...
#define VER_LEGALCOPYRIGHT_STR	"Copyright © @I 1991 - 2000, #@D\0"
#define VER_PRODUCTNAME_STR  	\
	"TRiAS® - Territoriales Raumbezogenes Informations- und Abfragesystem.\0"
#define VER_LEGALTRADEMARKS_STR	\
	"TRiAS® ist ein eingetragenes Warenzeichen der TRiAS GmbH.\0"
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"GdbAsc.\0"
#define VER_INTERNALNAME_STR		"MainApp\0"
#define VER_ORIGINALFILENAME_STR	"MAINAPP.EXE\0"
