...
APP_LONG		= Exportfilter - MapInfo Binärformat
!else if "0x0409" == "$(TRIAS_LANGUAGE)"
APP_LONG		= Exportfilter - MapInfo binary format
!else
...
!include $(TRIASINCLUDE)/triasverEx.mak
