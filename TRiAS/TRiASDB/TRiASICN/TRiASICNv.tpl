// VersionsInfoStruktur fuer TRiASICN.DLL 
// File: TRiASICN.RCV
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"Iconhandler für TRiAS-Dokumente.\0"
#define VER_INTERNALNAME_STR		"TRiASICN\0"
#define VER_ORIGINALFILENAME_STR	"TRiASICN.DLL\0"
