/**
 **	$Header: /sdsc/dev/vis/misc/libsdsc/v3.0/libsdsc/src/RCS/tag.c,v 1.12 1995/06/30 21:53:40 bduggan Exp $
...
#define HEADER	"    $Header: /sdsc/dev/vis/misc/libsdsc/v3.0/libsdsc/src/RCS/tag.c,v 1.12 1995/06/30 21:53:40 bduggan Exp $"
...
_CRTIMP extern int sys_nerr;			/* # of system call error codes	*/
_CRTIMP extern char *sys_errlist[];		/* Error code message strings	*/
...
#endif
{
	...
	{
	case IM_POINTER_TYPE:	(void)fprintf( stderr, "POINTER\n" ); break;
	case IM_CHAR_TYPE:	(void)fprintf( stderr, "CHAR\n" ); break;
	case IM_UCHAR_TYPE:	(void)fprintf( stderr, "UCHAR\n" ); break;
	case IM_SHORT_TYPE:	(void)fprintf( stderr, "SHORT\n" ); break;
	case IM_LONG_TYPE:	(void)fprintf( stderr, "LONG\n" ); break;
	case IM_INT_TYPE:	(void)fprintf( stderr, "INT\n" ); break;
	case IM_INT8_TYPE:	(void)fprintf( stderr, "INT8\n" ); break;
	case IM_INT16_TYPE:	(void)fprintf( stderr, "INT16\n" ); break;
	case IM_INT32_TYPE:	(void)fprintf( stderr, "INT32\n" ); break;
	case IM_USHORT_TYPE:	(void)fprintf( stderr, "USHORT\n" ); break;
	case IM_ULONG_TYPE:	(void)fprintf( stderr, "ULONG\n" ); break;
	case IM_UINT_TYPE:	(void)fprintf( stderr, "UINT\n" ); break;
	case IM_UINT8_TYPE:	(void)fprintf( stderr, "UINT8\n" ); break;
	case IM_UINT16_TYPE:	(void)fprintf( stderr, "UINT16\n" ); break;
	case IM_UINT32_TYPE:	(void)fprintf( stderr, "UINT32\n" ); break;
	case IM_BOOLEAN_TYPE:	(void)fprintf( stderr, "BOOLEAN\n" ); break;
	case IM_FLOAT_TYPE:	(void)fprintf( stderr, "FLOAT\n" ); break;
	case IM_DOUBLE_TYPE:	(void)fprintf( stderr, "DOUBLE\n" ); break;
	case IM_INT64_TYPE:	(void)fprintf( stderr, "INT64\n" ); break;
	case IM_UINT64_TYPE:	(void)fprintf( stderr, "UINT64\n" ); break;
