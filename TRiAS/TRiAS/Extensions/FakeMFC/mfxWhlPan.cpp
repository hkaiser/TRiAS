...
// Parent vom erfolgreichen installieren in Kenntnis setzen
	m_pParentWnd -> SendMessage (WM_TRACKAUTOPANSTART);
...
{
// Parent vom erfolgreichen beenden der Tätigkeit in Kenntnis setzen
	m_pParentWnd -> SendMessage (WM_TRACKAUTOPANEND);
