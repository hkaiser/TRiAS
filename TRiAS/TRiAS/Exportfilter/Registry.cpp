...
// Created: 21.11.2000 09:55:49 
//
// @doc
// @module Registry.cpp | Wrapperklassen für RegistryZugriff 
...
// alle Subkeys löschen (immer den ersten)
...
bool CRegistry::DeleteValue (LPCTSTR pcValueName)
{
DWORD retCode = RegDeleteValue(m_hKey, pcValueName);
