...
_TRIAS01_ENTRY long  FUNCTYPE EXPORT01 FlexReserve (short lnum, long new_elems);
_TRIAS01_ENTRY long  FUNCTYPE EXPORT01 FlexAccessAdr (short lnum, long **Address, unsigned long **pLen);
