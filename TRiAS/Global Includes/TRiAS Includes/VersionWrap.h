...
public:
	_TRIAS03_ENTRY CVersionBind (void);

_TRIAS03_ENTRY DWORD GetFileVersionInfoSize (LPSTR lptstrFilename, LPDWORD lpdwHandle);
_TRIAS03_ENTRY BOOL GetFileVersionInfo (LPSTR lptstrFilename, DWORD dwHandle, DWORD dwLen, LPVOID lpData);
_TRIAS03_ENTRY BOOL VerQueryValue (const LPVOID pBlock, LPSTR lpSubBlock, LPVOID *lplpBuffer, PUINT puLen);
