// VersionsInfoStruktur fuer KOMPAKT.EXT --------------------------------------
// File: KOMPIAS.RCV-V3.0
...
#define VER_FILEDESCRIPTION_STR		\
	...
	"Erweiterung zum Integrierten Gewässer-Management.\0"
#define VER_INTERNALNAME_STR		"TRIASIGM\0"
#define VER_ORIGINALFILENAME_STR	"TRIASIGM.EXT\0"
