...
extern class COverViewClientWindow *pOverView;	// Gesamtübersicht
...
// wird der Pseudo-Identifikator einer evtl. Zuordnungsobjektklasse benötigt, dann
// muß mit hPr == HACTPROJECT gerufen werden
...
#else
	if (HACTPROJECT == hPr) 
		return FALSE;		// Projekte sind nie wirklich schreibgeschützt
...
{	
	...
	LegendToRepaint = true;
#if !defined(WIN16)
	m_pView -> SetShouldRedraw (false);		// Bitmap nicht vollständig löschen
...
// @msg DEX_ENUMMERKMALECLASSEX | Mit dieser Message an <tr> ist es möglich alle Merkmale
...
PBDDATA *pPD = (PBDDATA *)lParam;
	...
	TX_ASSERT_POINTER(pPD, DWORD);
// #HK980415: jetzt Beschreibbarkeit testen, da ggf. Handle zurückgeliefert werden kann
	if (sizeof(PBDMERKMAL) == pPD -> dwSize || sizeof(PBDMERKMALEX) == pPD -> dwSize) {
